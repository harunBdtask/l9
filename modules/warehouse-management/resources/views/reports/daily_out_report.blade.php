...
@section('title', 'Date Wise Warehouse Out Report')
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header text-center">
                        <h2>Date Wise Warehouse Out Report
                            <span class="pull-right">
                                <a href="{{ url('warehouse-daily-out-report-download/pdf/'.$from_date.'/'.$to_date) }}">
                                    <i style="color: #DC0A0B" class="fa fa-file-pdf-o"></i></a> | 
                                <a href="{{ url('warehouse-daily-out-report-download/excel/'.$from_date.'/'.$to_date) }}"><i
                    ...
                    <div class="box-body">
                        <form action="{{ url('/warehouse-daily-out-report') }}" method="post">
                            @csrf
