    ...
    <div class="padding">
        <div class="box">
            <div class="box-header">
                <h2>Finish Fabric Store Report</h2>
                <div class="clearfix"></div>
            </div>
            <div class="box-body table-responsive b-t">
                <div class="row">
                    {!! Form::open(['url'=>'/finish-fabric-report/get-report', 'id'=>'reportForm']) !!}
                    <div class="col-sm-12">
                        <div class="row">
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <label>From Date</label>
                                    {!! Form::date('from_date', \Carbon\Carbon::now()->subMonth(6),
                ...
                <script>
                    ...
                    $(document).ready(function () {
                        ...
                        $('.print').click(function (e) {
                            e.preventDefault();
                            let link = `/finish-fabric-report/get-report-print?${queryString}`;
                        ...
                        $(document).on('submit', '#reportForm', function (e) {
                            ...
                            reportTable.empty();
                            $.ajax({
                                url: "/inventory/finish-fabric-report/get-report",
                                type: "post",
                                dataType: "html",
                                data: formData,
                                beforeSend() {
                        ...
                        $(document).on('click', '#report_pdf', function () {
                            window.location.replace(`/inventory/finish-fabric-report/get-report-pdf?${queryString}`);
                        });

                        $(document).on('click', '#report_excel', function () {
                            window.location.replace(`/inventory/finish-fabric-report/get-report-excel?${queryString}`);
                        });
