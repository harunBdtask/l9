...
@section('title','Finish Fabric Monthly Stock Report')
@section('content')
    <style type="text/css">
        #pdfGenerateInfo {
            display: none;
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-sm-1">
                                    <div class="text-center">
                                        <button style="margin-top: 19px;" id="fabricMonthlyStockReport"
...
{{--                               href="finish-fabric-monthly-stock-report-pdf"><i--}}
{{--                                    class="fa fa-file-pdf-o"></i>--}}
{{--                            </a>--}}

                            <a id="finish_fabric_stock_report_excel" data-value="" class="btn"
                               href="finish-fabric-monthly-stock-report-excel">
                        ...
                        <table style="border: 1px solid black;width: 20%;">
                            ...
                            <tr>
                                <td class="text-center">
                                    <span style="font-size: 10pt; font-weight: bold;">Finish Fabric Stock Report</span>
                                    <br>
                                </td>
                            </tr>
                            </thead>
                    ...
                    <br>
                    <div class="row p-x-1">
                        <div class="col-md-12" id="finishFabricMonthlyStockTable">
        ...
        @push("script-head")
            <script>
                ...
                function getReportData() {
                    ...
                    let style = $('#style').val();
                    let color = $('#color').val();
                    let reportTable = $('#finishFabricMonthlyStockTable');
                    reportTable.empty();
                    ...
                    if (form_date == '' || to_date == '') {
                        ...
                        $.ajax({
                            method: 'GET',
                            url: `date-wise-finish-fabric-monthly-stock-report`,
                            data: {
                                form_date,
                                to_date,
                                buyer,
                            ...
                            success: function (result) {
                                ...
                                let excelQueryString = `/inventory/finish-fabric-stock-report-excel?form_date=${form_date}&to_date=${to_date}
                                ...
                                $("#finish_fabric_stock_report_excel").attr('href', excelQueryString)
                                // console.log(result)
                            },
                ...
                $(document).ready(function () {
                    getReportData();
                    $(document).on('click', '#fabricMonthlyStockReport', function (event) {
                        getReportData();
                    });
