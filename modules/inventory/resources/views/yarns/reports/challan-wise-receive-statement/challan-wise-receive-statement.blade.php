...
@section('title','Challan Wise Yarn Receive Statement')
@section('content')
    <div class="padding">
        <div class="box">
            <div class="box-header">
                <h2> Challan Wise Yarn Receive Statement </h2>
            </div>
            <div class="box-body">
                <div class="row">
                    <form class="col-md-12 table-responsive" method="GET"
                          action="{{ url('/inventory/challan-wise-receive-statement') }}">
                        <table class="reportTable" style="background-color: aliceblue">
                            ...
                            <tr>
                                ...
                                <th>Party Name</th>
                                <th>Receive Basis</th>
                                <th style="min-width: 80px;">Goods RCV By</th>
                                ...
                                <th>
                                    <a style="line-height: 1"
                                       ...
                                       href="{{url('inventory/challan-wise-receive-statement')}}">
                                        Clear
                                    </a>
                                </th>
                            </tr>
