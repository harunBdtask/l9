                                ...
                                <td>
                                    <div style="width: 105px;">
                                        <select name="receive_basis"
                                            ...
                                            <option value="">Select</option>
                                            <option
                                                {{ request()->get('receive_basis') == 'independent' ? 'selected' : '' }} value="independent">
                                                Indepedent
                                            </option>
                                            <option
                                                {{ request()->get('receive_basis') == 'pi' ? 'selected' : '' }} value="pi">
                                                PI Basis
                                            </option>
                                            <option
                                                {{ request()->get('receive_basis') == 'wo' ? 'selected' : '' }} value="wo">
                                                WO Basis
                                            </option>
                                        </select>
                                    </div>
