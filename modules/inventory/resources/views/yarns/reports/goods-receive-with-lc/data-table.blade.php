<table class="reportTable table">
    ...
    <tr>
        ...
        <th style="background-color: aliceblue !important;" colspan="5"><b>PI/Procurement Details</b></th>
    ...
    <tr>
        ...
        <td><b>Lot No</b></td>
        <td><b>PI No</b></td>
        <td style="width: 70px;"><b>PI Date</b></td>
        <td><b>PI Qty</b></td>
        <td><b>L/C No</b></td>
        <td style="width: 70px;"><b>L/C Date</b></td>
        <td><b>RCV Qty</b></td>
        <td><b>Bal. Qty</b></td>
        <td><b>Rate</b></td>
        ...
        @foreach($piGroup->groupBy('party_id') as $partyGroup)
            @foreach($partyGroup as $value)
                ...
                <tr>
                    ...
                    <td>{{ $value['lc_date'] ? date('d-m-Y', strtotime($value['lc_date'])) : '' }}</td>
    ...
    <tr>
        ...
        <th style="background-color: aliceblue !important;"></th>
        <th style="background-color: aliceblue !important;"></th>
        <th style="background-color: aliceblue !important; text-align: right">
            ${{ numberFormat(collect($reportData)->sum('receive_value')) }}</th>
        <th style="background-color: aliceblue !important;"></th>
    </tr>
    </tbody>
</table>
