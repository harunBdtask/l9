...
@section('title','Goods Receive with LC')
@section('content')
    <div class="padding">
        <div class="box">
            <div class="box-header">
                <h2> Goods Receive with LC </h2>
            </div>
            <div class="box-body">
                <div class="row">
                    <form class="col-md-12 table-responsive" method="GET"
                          action="{{ url('/inventory/yarn-store/goods-receive-with-lc') }}">
                        <table class="reportTable">
                            <tr>
                                ...
                                <th colspan="2" style="background-color: aliceblue !important; width: 15%">Brand</th>
                            </tr>
                            ...
                            <tr>
                                ...
                                <th style="background-color: aliceblue !important; width: 15%">LC No.</th>
                                ...
                                <th style="background-color: aliceblue !important;">
                                    <a style="line-height: 1"
                                       ...
                                       href="{{url('/inventory/yarn-store/goods-receive-with-lc')}}">
                                        Clear
                                    </a>
                                </th>
                            </tr>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 table-responsive">
                        @include('inventory::yarns.reports.goods-receive-with-lc.data-table', [
