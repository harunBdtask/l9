...
class YarnStockSummarySupplierLotWiseExport implements WithTitle, ShouldAutoSize, FromView, ShouldQueue, withEvents
{
    use Exportable;
    ...
    {
        return view('inventory::yarns.reports.yarn-stock-summary-supplier-lot-wise.excel', [
