...
class GoodsReceivedWithoutLCExport implements WithTitle, ShouldAutoSize, FromView, ShouldQueue, withEvents
{
    use Exportable;
    ...
    {
        return 'Goods Received Without LC';
    }
    ...
    {
        return view('inventory::yarns.reports.goods-receive-without-lc.excel', [
