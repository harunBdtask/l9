...
class DailyYarnReceiveReport implements WithTitle, ShouldAutoSize, FromView, ShouldQueue, withEvents
{
    use Exportable;
    ...
    {
        return 'Daily Yarn Receive Statement';
    }
    ...
    {
        return view('inventory::yarns.reports.daily-yarn-receive-statement.excel', [
