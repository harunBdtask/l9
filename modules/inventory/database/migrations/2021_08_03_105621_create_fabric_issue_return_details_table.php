...
class CreateFabricIssueReturnDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('fabric_issue_return_details', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('fabric_issue_return_details');
    }
}
