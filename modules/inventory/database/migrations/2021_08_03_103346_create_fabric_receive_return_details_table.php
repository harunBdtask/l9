...
class CreateFabricReceiveReturnDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('fabric_receive_return_details', function (Blueprint $table) {
            $table->id();
            $table->string('unique_id', 30);
            $table->unsignedBigInteger('receive_return_id');
    ...
    {
        Schema::dropIfExists('fabric_receive_return_details');
    }
}
