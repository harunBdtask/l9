...
class CreateFabricIssueDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('fabric_issue_details', function (Blueprint $table) {
            $table->id();
            $table->string('unique_id', 30);
            $table->unsignedInteger('sample_type')->nullable();
            ...
            $table->string('issue_qty', 20);
            $table->json('issue_qty_details')->nullable();
    ...
    {
        Schema::dropIfExists('fabric_issue_details');
    }
}
