            ...
            <div class="row flex flex-row">
              ...
              <div class="column-33 text-center br-1 flex justify-content-center align-items-center">
                <span class="p-tb-2">B/N:
                  &nbsp;{{ $bundleCardFirstCol['size_wise_bundle_no'] ?? $bundleCardFirstCol['bundle_no'] }}</span>
              </div>
              <div class="column-25 text-center flex justify-content-center align-items-center">
                <span
                  class="p-tb-2">{{ 'F:'.($bundleCardGenerationDetail->cuttingTable->cuttingFloor->floor_no ? substr($bundleCardGenerationDetail->cuttingTable->cuttingFloor->floor_no, 0, 2): '') }}</span>
              </div>
            </div>
            <div class="row flex flex-row">
              <div class="column-66 text-center br-1 flex justify-content-center align-items-center">
                <span class="p-tb-2">PO:
                  {{ $bundleCardFirstCol->purchaseOrder->po_no ? substr($bundleCardFirstCol->purchaseOrder->po_no, 0, 15) : '' }}</span>
              </div>
              <div class="column-33 text-center br-1 flex justify-content-center align-items-center">
                <span class="p-tb-2">{{ $bundleCardFirstCol->size_name ?? '' }}</span>
              </div>
              <div class="column-25 text-center flex justify-content-center align-items-center">
                <span
                  class="p-tb-2">{{ 'T:'.substr($bundleCardGenerationDetail->cuttingTable->table_no, 0, 2) ?? '' }}</span>
              </div>
            </div>
            <div class="row flex flex-row">
              <div class="column-66 text-center br-1 flex justify-content-center align-items-center">
              ...
              <div class="column-33 text-center br-1 flex justify-content-center align-items-center">
                <span
                  class="p-tb-2">{{ $bundleCardGenerationDetail->part ? substr($bundleCardGenerationDetail->part->name, 0, 12) : '' }}</span>
              </div>
              <div class="column-25 text-center flex justify-content-center align-items-center">
