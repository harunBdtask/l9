...
class MonthlyFabricConsumptionReportExport implements WithTitle, ShouldAutoSize, FromView, ShouldQueue, WithEvents
{
    ...
    {
        return "Consumption of ". date('F', mktime(0, 0, 0, $this->result_data['month'], 10)) ." ". $this->result_data['year'];
    }
    ...
    public function view(): View
    {
        ...
        return view('cuttingdroplets::reports.downloads.excels.monthly_fabric_consumption_report_download', $data);
    }
