...
class TableWiseCuttingReportSummeryExport implements WithTitle, ShouldAutoSize, FromView, ShouldQueue, WithEvents
{
    ...
    {
        return 'Table Wise Cutting Report';
    }
    ...
    public function view(): View
    {
        ...
        return view('cuttingdroplets::reports.tables.table_wise_production_summary_table', $data);
    }
