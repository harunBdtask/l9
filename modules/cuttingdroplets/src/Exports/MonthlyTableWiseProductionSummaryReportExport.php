...
class MonthlyTableWiseProductionSummaryReportExport implements WithTitle, ShouldAutoSize, FromView, ShouldQueue, WithEvents
{
    ...
    {
        return date('F', mktime(0, 0, 0, $this->result_data['month'], 10)) .' - '.date('Y', strtotime($this->result_data['year']));
    }
    ...
    public function view(): View
    {
        ...
        return view('cuttingdroplets::reports.downloads.excels.monthly_table_wise_production_summary_report_download', $data);
    }
