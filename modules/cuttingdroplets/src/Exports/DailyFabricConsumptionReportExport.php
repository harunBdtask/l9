...
class DailyFabricConsumptionReportExport implements WithTitle, ShouldAutoSize, FromView, ShouldQueue, WithEvents
{
    ...
    {
        return "Consumption Report ". date('d-m-Y', strtotime($this->result_data['cutting_date']));
    }
    ...
    public function view(): View
    {
        ...
        return view('cuttingdroplets::reports.downloads.excels.daily_fabric_consumption_report_download', $data);
    }
