...
class BundleCard extends Model
{
    use FactoryIdTrait;
    use SoftDeletes;

    protected $table = 'bundle_cards';
    ...
    {
        return $this->belongsTo(BundleCardGenerationDetail::class, 'bundle_card_generation_detail_id')->withDefault();
    }
