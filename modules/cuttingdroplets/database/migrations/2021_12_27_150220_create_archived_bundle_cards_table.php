...
class CreateArchivedBundleCardsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('archived_bundle_cards', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->unsignedInteger('garments_item_id')->nullable()->index();
            ...
            $table->index('bundle_card_generation_detail_id');
            $table->index('buyer_id');
            $table->index('cutting_no');
    ...
    {
        Schema::dropIfExists('archived_bundle_cards');
    }
}
