...
class CreateBundleCardGenerationDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bundle_card_generation_details', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->index(['sid', 'buyer_id', 'order_id']);
    ...
    {
        Schema::dropIfExists('bundle_card_generation_details');
    }
}
