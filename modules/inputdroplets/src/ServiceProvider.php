...
namespace SkylarkSoft\GoRMG\Inputdroplets;

use Illuminate\Support\ServiceProvider as LaravelProvider;
use Illuminate\Support\Facades\View;
use SkylarkSoft\GoRMG\Inputdroplets\Commands\DailyChallanWiseInputModelUpdateCommand;
...
use SkylarkSoft\GoRMG\Inputdroplets\Observers\CuttingInventoryChallanObserver;
use SkylarkSoft\GoRMG\Inputdroplets\Observers\CuttingInventoryObserver;
...
class ServiceProvider extends LaravelProvider
{
    ...
    public function boot()
    {
        ...
        $this->publishAssets();
        $this->commands([
            DailyChallanWiseInputModelUpdateCommand::class
        ]);

        CuttingInventory::observe(CuttingInventoryObserver::class);
        CuttingInventoryChallan::observe(CuttingInventoryChallanObserver::class);
    }
