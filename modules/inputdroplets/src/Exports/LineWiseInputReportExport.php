...
class LineWiseInputReportExport implements WithTitle, ShouldAutoSize, FromView, ShouldQueue, WithEvents
{
    ...
    public function view(): View
    {
        ...
        return view('inputdroplets::reports.tables.floor_line_wise_input_report_table', $data);
    }
