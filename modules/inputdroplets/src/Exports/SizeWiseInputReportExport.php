...
class SizeWiseInputReportExport implements WithTitle, ShouldAutoSize, FromView, ShouldQueue
{
    use Exportable;
    ...
    public function view(): View
    {
        ...
        return view('inputdroplets::reports.downloads.excels.color-size-wise-sewing-input-report-download', $data, $report_head);
    }
}