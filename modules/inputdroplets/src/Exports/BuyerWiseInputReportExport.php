...
class BuyerWiseInputReportExport implements WithTitle, ShouldAutoSize, WithMapping, WithHeadings, FromQuery, WithEvents, ShouldQueue, WithCustomChunkSize
{
    use Exportable;
    ...
    {
        return 'Buyer Wise Input Report';
    }
