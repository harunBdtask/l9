            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-md-12 m-b">
                        <a href="{{ url('dyeing/tumbles/create') }}"
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="reportTable">
                            ...
                            <tbody>
                            {!! Form::open(['url'=>'/dyeing/tumbles', 'method'=>'GET']) !!}
                            <tr>
                                <td>*</td>
                                <td>
                            ...
                            {!! Form::close() !!}
                             <tr>
                                ...
                                @forelse ($tumbles as $tumble)
                                @php
                                    $fabricColor = collect($tumble->tumbleDetails)
                                ...
                                <tr>
                                    ...
                                    <td style="text-transform: capitalize">{{ $tumble->dyeingBatch->fabricSalesOrder->booking_type??null  }}</td>
                                    <td>{{$tumble->buyer->name}}</td>
                                    <td>{{$tumble->textile_order_no}}</td>
                                    <td>{{$tumble->dyeing_batch_no}}</td>
                                    <td>{{$fabricColor}}</td>
                                    <td>{{$tumble->total_finish}}</td>
                                    <td>
                                        <a class="btn btn-xs btn-info" type="button"
                                            href="{{ url('dyeing/tumbles/create?id=' . $tumble->id) }}">
                                            <em class="fa fa-pencil"></em>
                                        </a>
                                        <a class="btn btn-success btn-xs" type="button"
                                            href="{{ url('dyeing/tumbles/view/' . $tumble->id) }}">
                                        ...
                                        <button style="margin-left: 2px;" type="button"
                                                ...
                                                ui-target="#animate"
                                                data-url="{{ url('dyeing/tumbles/' . $tumble->id) }}">
                        ...
                        <div class="text-center">
                            {{ $tumbles->appends(request()->except('page'))->links() }}
                        </div>
                    </div>
                </div>
            </div>
