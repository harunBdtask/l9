...
namespace SkylarkSoft\GoRMG\Dyeing\Models\TextileModels\Dryer;
...
use SkylarkSoft\GoRMG\Dyeing\Services\TextileServices\UId\DryerService;
...
class Dryer extends Model
{
    ...
    public static function booted()
    {
        static::saving(function ($model) {
            if (!$model->id && in_array('created_by', $model->getFillable())) {
                $model->unique_id = DryerService::generateUniqueId();
            }
        });
    }
    ...
    public function dryerDetails(): HasMany
    {
        return $this->hasMany(DryerDetail::class, 'dryer_id');
    }
