...
class StenteringDetail extends Model
{
    use SoftDeletes;
    use CommonModelTrait;

    protected $table = 'stentering_details';
    ...
    public function stentering(): BelongsTo
    {
        return $this->belongsTo(Stentering::class, 'stentering_id')
            ->withDefault();
    }
