...
class CreateStenteringDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('stentering_details', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('stentering_id');
    ...
    {
        Schema::dropIfExists('stentering_details');
    }
}
