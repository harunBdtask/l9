...
class CreateTumbleDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tumble_details', function (Blueprint $table) {
            $table->id();
            $table->unsignedInteger('tumble_id');
    ...
    {
        Schema::dropIfExists('tumble_details');
    }
}
