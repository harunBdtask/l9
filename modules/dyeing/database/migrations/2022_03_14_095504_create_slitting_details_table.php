...
class CreateSlittingDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('slitting_details', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('slitting_id');
    ...
    {
        Schema::dropIfExists('slitting_details');
    }
}
