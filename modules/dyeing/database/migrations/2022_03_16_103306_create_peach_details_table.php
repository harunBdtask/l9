...
class CreatePeachDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('peach_details', function (Blueprint $table) {
            $table->id();
            $table->unsignedInteger('dyeing_peach_id');
    ...
    {
        Schema::dropIfExists('peach_details');
    }
}
