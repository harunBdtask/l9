...
class BeforeOrderFabricBookingSearch implements SalesOrderBookingSearchContract
{
    ...
    public function format(SalesOrderBookingSearch $salesOrderBookingSearch): array
    {
        ...
        return SampleBookingBeforeOrder::query()
            ->with(['supplier', 'buyer', 'currency', 'details.fabricNature'])
