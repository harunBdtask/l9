...
class DailyKnittingReportExcel implements WithTitle, FromView, WithEvents
{
    use Exportable;
    ...
    {
        return 'Daily Knitting Report';
    }

    public function view(): View
    {
        return view('knitting::reports.daily-knitting-report.excel', $this->reportDate);
    }
