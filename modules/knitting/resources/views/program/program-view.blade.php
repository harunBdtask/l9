...
@section('title','Knitting Program')
@section('content')
    <div class="padding">
        <div class="box">
            <div class="box-body">
                ...
                <div style="text-align: center; margin-top: 20px;">
                    <u style="font-size: 15px; font-weight: bold;">Knitting Program</u>
                </div>
                                        ...
                                        @foreach($yarn as $index => $value)
                                            @if($index == 0)
                                                <tr style="text-align: center;">
                                                    ...
                                                    <td rowspan="{{ $data->total_row }}">{{ $program->planInfo->fabric_description }}</td>
