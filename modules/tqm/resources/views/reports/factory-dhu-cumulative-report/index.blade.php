...
@section('title', 'Factory DHU Report Cumulative')
@section('content')
    <style>
    ...
    <div class="padding">
        <div class="box">
            <div class="box-header">
                <h2>Factory DHU Report Cumulative</h2>
                ...
                <div class="row">
                    <form id="reportForm">
                        <div class="col-sm-12">
                            <div class="row">
                                <div class="col-sm-3">
                                    <label>Month <span class="text-danger req">*</span></label>
                                    {!! Form::selectMonth('month', (int)date('m'), ['class' => 'form-control form-control-sm select2-input', 'id' =>'month']) !!}
                                  </div>
                                <div class="col-sm-1">
...
@push("script-head")
    <script>
        ...
        function getReport() {
            ...
            reportTable.empty();
            $.ajax({
                url: "/factory-dhu-cumulative-report/get",
                type: "get",
                dataType: "html",
                data: formData,
                beforeSend() {
