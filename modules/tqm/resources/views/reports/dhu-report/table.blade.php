...
<script>
    const series = '@json($data['defects_percentages'])';
    const labels = '@json($data['defects'])';
    const options = {
    ...
    const chart = new ApexCharts(document.querySelector("#defectsChart"), options);
    chart.render();
</script>
