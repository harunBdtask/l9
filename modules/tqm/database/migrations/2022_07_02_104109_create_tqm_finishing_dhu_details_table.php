...
class CreateTqmFinishingDhuDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tqm_finishing_dhu_details', function (Blueprint $table) {
            $table->id();
            $table->unsignedInteger('tqm_finishing_dhu_id');
    ...
    {
        Schema::dropIfExists('tqm_finishing_dhu_details');
    }
}
