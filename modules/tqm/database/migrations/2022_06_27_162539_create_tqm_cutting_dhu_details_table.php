...
class CreateTqmCuttingDhuDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tqm_cutting_dhu_details', function (Blueprint $table) {
            $table->id();
            $table->unsignedInteger('tqm_cutting_dhu_id');
    ...
    {
        Schema::dropIfExists('tqm_cutting_dhu_details');
    }
}
