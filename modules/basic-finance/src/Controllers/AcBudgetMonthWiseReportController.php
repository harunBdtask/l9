...
use SkylarkSoft\GoRMG\BasicFinance\Services\Budgets\AcBudgetMonthWiseReport;

class AcBudgetMonthWiseReportController extends Controller
{
    public function index()
    {
        ...
        return view(PackageConst::VIEW_NAMESPACE . '::reports.budget.month_wise_report', [
            'accounts' => $accounts,
        ]);
    }
    ...
    {
        $reportData = (new AcBudgetMonthWiseReport())->reportData($request, new BudgetDTO());
    ...
    public function pdf(Request $request)
    {
        ...
        $pdf = PDF::setOption('enable-local-file-access', true)
            ->loadview(PackageConst::VIEW_NAMESPACE . '::reports.budget.pdf.month_wise_report_pdf', [
                ...
                'header-html' => view('skeleton::pdf.header', ['name' => 'Order Report']),
                'footer-html' => view('skeleton::pdf.footer'),
            ]);

        return $pdf->stream('budget_month_wise_report.pdf');
    }
    ...
    public function excel(Request $request)
    {
        ...
        return Excel::download((new Export(['report_data' => $reportData], $title, $viewFile)), 'month_wise_report.xlsx');
    }
}
