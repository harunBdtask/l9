...
use SkylarkSoft\GoRMG\BasicFinance\Services\VoucherNotificationService;
...
class Voucher extends Model
{
    ...
    {
        return collect(CurrencyService::currencies())->where('id', $this->attributes['currency_id'])->first()['name'] ?? null;
    }
    ...
    public static function booted()
    {
        ...
        static::created(function ($model) {
            VoucherNotificationService::voucherCreated($model);
        });
        static::updated(function ($model) {
            VoucherNotificationService::voucherChecked($model);
        });
    }
}
