...
@section('title','Unclear Cheque List')
@section('content')
    <style type="text/css">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="due_date"
                                               value="{{ empty(request('due_date')) ? Carbon\carbon::today()->endOfMonth() : request('due_date') }}"
                                               class="form-control select2-input" id="due_date">
                                    </div>
                                </div>
                                <div class="col-sm-1">
                                    <div class="form-group">
                            ...
                            <table style="border: 1px solid black;width: 20%;">
                                ...
                                <tr>
                                    <td class="text-center">
                                        <span style="font-size: 12pt; font-weight: bold;">Unclear Cheque List</span>
                                        <br>
                                    </td>
                                </tr>
                                </thead>
