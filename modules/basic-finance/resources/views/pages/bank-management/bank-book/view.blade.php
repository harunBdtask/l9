                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="from_date" value="{{ empty(request('from_date')) ? Carbon\carbon::today()->startOfMonth() : request('from_date') }}" class="form-control select2-input" id="from_date">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>To Date</label>
                                        <input type="date" name="to_date" value="{{ empty(request('to_date')) ? Carbon\carbon::today()->endOfMonth() : request('to_date') }}" class="form-control select2-input" id="to_date">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                ...
                <div class="">
                    <div class="header-section" style="padding-bottom: 0px;">
                        <div class="pull-right" style="margin-bottom: -5%;">
                            <a class="btn" href="/basic-finance/bank-management/bank-book?{{ Request::getQueryString().'&type=pdf' }}"><i class="fa fa-file-pdf-o"></i></a>
                        </div>
                    </div>
                    <center>
                        <table style="border: 1px solid black;width: 20%;">
                            ...
                            <tr>
                                <td class="text-center">
                                    <span style="font-size: 12pt; font-weight: bold;">Bank Book</span>
                                    <br>
                                </td>
                            </tr>
                            </thead>
                    ...
                    <div class="body-section" style="margin-top: 0;">
                        <div class="row">
                            <div class="col-lg-12">
                                @includeIf('basic-finance::pages.bank-management.bank-book.table')
                            </div>
                        </div>
                    </div>
