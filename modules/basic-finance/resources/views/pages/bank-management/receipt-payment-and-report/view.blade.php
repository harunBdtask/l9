...
@section('title', 'Bank Receipt and Payment Statement Report')
@section('styles')
    <style type="text/css">
        .addon-btn-primary {
            padding: 0;
    ...
    <div class="padding">
        <div class="box">
            <div class="box-header">
                <h2>Bank Receipt and Payment Statement Report</h2>
            </div>
                ...
                <div class="">
                    <div class="header-section" style="padding-bottom: 0px;">
                        <div class="pull-right" style="margin-bottom: -5%;">
                            <a class="btn"
                               href="/basic-finance/bank-receipts-and-payments?{{ Request::getQueryString().'&type=pdf' }}"><i
                        ...
                        <table style="border: 1px solid black;width: 30%;">
                            ...
                            <tr>
                                <td class="text-center">
                                    <span style="font-size: 12pt; font-weight: bold;">Bank Receipt and Payment Statement Report</span>
                                    <br>
                                </td>
                            </tr>
                            </thead>
                    ...
                    <div class="body-section" style="margin-top: 0;">
                        <div class="row">
                            <div class="col-lg-12">
                             @includeIf('basic-finance::pages.bank-management.receipt-payment-and-report.table')
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            function fetchAccounts(companyId) {
                axios.get(`/basic-finance/api/v1/fetch-company-wise-bank-accounts/${companyId}`)
                    .then((response) => {
