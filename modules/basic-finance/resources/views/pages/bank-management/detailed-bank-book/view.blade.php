                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <select name="ledger" class="form-control select2-input" id="ledger">
                                            ...
                                            @foreach($bankBookAccounts as $item)
                ...
                <div class="">
                    <div class="header-section" style="padding-bottom: 0px;">
                        <div class="pull-right" style="margin-bottom: -5%;">
                            <a class="btn" href="/basic-finance/bank-management/detailed-bank-book?{{ Request::getQueryString().'&type=pdf' }}"><i class="fa fa-file-pdf-o"></i></a>
                        </div>
                    </div>
                    <center>
                        <table style="border: 1px solid black;width: 20%;">
                            ...
                            <tr>
                                <td class="text-center">
                                    <span style="font-size: 12pt; font-weight: bold;">Detailed Bank Book</span>
                                    <br>
                                </td>
                            </tr>
                            </thead>
                    ...
                    <div class="body-section" style="margin-top: 0;">
                        <div class="row">
                            <div class="col-lg-12">
                                @includeIf('basic-finance::pages.bank-management.detailed-bank-book.table')
                            </div>
                        </div>
                    </div>
