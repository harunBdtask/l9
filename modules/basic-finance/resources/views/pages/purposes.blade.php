                ...
                <div class="col-sm-12 col-md-3">
                    <div class="box">
                        <div class="box-body b-t">
                            {{ Form::open(array('id'=> 'form', 'url' => '/basic-finance/fund-requisition/purposes', 'method' => 'POST')) }}
                ...
                <div class="col-sm-12 col-md-9">
                    <div class="box-body b-t">
                        ...
                        <div class="col-sm-6">
                            ...
                            {!! Form::open(['url' => '/basic-finance/fund-requisition/purposes/search', 'method' => 'GET']) !!}
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-xs btn-danger show-modal"
                                                    ...
                                                    data-url="{{ url('basic-finance/fund-requisition/purposes/'.$purpose->id.'/delete') }}">
...
@push('script-head')
    ...
    <script>
        $(document).on('click', '.edit', function () {
            ...
            $.ajax({
                method: 'get',
                url: '{{ url('basic-finance/fund-requisition/purposes') }}/' + id + '/edit',
                success: function (result) {
                    $('#box-header').addClass('change-color')
                    $('#box-header h2').html('Update Section Info')
                    $('#form').attr('action', `/basic-finance/fund-requisition/purposes/${result.id}`).append(`<input type="hidden" id="_method" name="_method" value="PUT"/>`);
        ...
        function cancel() {
            ...
            $('#purpose').val('');
            $('#form').attr('action', '/basic-finance/fund-requisition/purposes').append(`<input type="hidden" id="_method" name="_method" value="POST"/>`);
