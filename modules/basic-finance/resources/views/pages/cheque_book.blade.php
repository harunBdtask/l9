            ...
            <div class="box-body b-t">
                <div class="voucher-meta">
                    <div class="col-md-5 ">
                        <div class="form-group row">
                            <label class="col-sm-5 form-control-label text-right"><b>Bank :</b></label>
                            <div class="col-sm-7 form-control-label text-left">
                                <p>{{ $cheque_book->bank->short_name }}</p>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-5 form-control-label text-right"><b>Cheque Book No :</b></label>
                            <div class="col-sm-7 form-control-label text-left">
                                <p>{{ $cheque_book->cheque_book_no }}</p>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-5 form-control-label text-right"><b>Cheque No From :</b></label>
                            <div class="col-sm-7 form-control-label text-left">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="tabular-form">
                        ...
                        @else
                            <tr>
                                <td colspan="13" class="text-danger">No Data Found</td>
                            </tr>
                        @endif
                        </tbody>
                    </table>
