        ...
        <div class="box">
            ...
            <div class="box-body table-responsive b-t">
                <div class="box-body">
                    ...
                    <a class="btn btn-sm white m-b" href="{{ url('basic-finance/projects/create') }}">
                        ...
                        @foreach($projects as $project)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{url('basic-finance/projects/'.$project->id.'/edit')}}" class="btn btn-xs btn-success" data-toggle="tooltip" data-placement="top" title="Edit"><i
                                    ...
                                    <button type="button" class="btn btn-xs btn-danger show-modal" data-toggle="modal"
                                            ...
                                            data-url="{{ url('basic-finance/projects/'.$project->id) }}">
