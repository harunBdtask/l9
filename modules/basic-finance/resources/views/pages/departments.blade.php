        ...
        <div class="box">
            ...
            <div class="box-body table-responsive b-t">
                <div class="box-body">
                    ...
                    <a class="btn btn-sm white m-b" href="{{ url('basic-finance/departments/create') }}">
                    ...
                    @if(count($departments))
                        @foreach($departments as $department)
                            <tr>
                                ...
                                <td>{!! $department->is_accounting?'<span style="color:green">Yes</span>':'<span style="color:red">No</span>' !!}</td>
                                <td>
                                    @permission('permission_of_departments_edit')
                                    <a href="{{url('basic-finance/departments/'.$department->id.'/edit')}}" class="btn btn-xs btn-success" data-toggle="tooltip" data-placement="top" title="Edit"><i
                                    ...
                                    <button type="button" class="btn btn-xs btn-danger show-modal" data-toggle="modal"
                                            ...
                                            data-url="{{ url('basic-finance/departments/'.$department->id) }}">
