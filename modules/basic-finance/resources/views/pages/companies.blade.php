    ...
    <div class="padding">
        <div class="box">
            ...
            <div class="box-body table-responsive b-t">
                <div class="box-body">
                    <a class="btn btn-sm white m-b" href="{{ url('basic-finance/companies/create') }}">
                ...
                <table class="reportTable">
                    ...
                    @if(!$companies->getCollection()->isEmpty())
                        @foreach($companies->getCollection() as $cmp)
                            <tr>
                                ...
                                <td>{{ $cmp->email }}</td>
                                <td>
                                    <a href="{{url('basic-finance/companies/'.$cmp->id.'/edit')}}" class="btn btn-xs btn-success" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></a>
                                    <button type="button" class="btn btn-xs btn-danger show-modal" data-toggle="modal"
                                            ...
                                            data-url="{{ url('basic-finance/companies/'.$cmp->id) }}">
                    ...
                    @if($companies->total() > 15)
                        <tr>
                            <td colspan="11" align="center">{{ $companies->appends(request()->except('page'))->links() }}</td>
                        </tr>
                    @endif
                    </tfoot>
                </table>
