...
<head>
    ...
    <title>Actual Month Wise Receipt and Payment Report</title>
...
{{--                <td><img src="{{factoryImage()}}"></td>--}}
    ...
    <div class="body-section" style="margin-top: -10px;">
        <table class="borderless">
            <thead>
            <tr>
                <td nowrap class="text-center" width="1%" style="padding:0px; margin: 0px">Report Title: <b> Actual Month Wise Receipt Payment Report</b></td>
            </tr>
            </thead>
        </table>
        <br>
