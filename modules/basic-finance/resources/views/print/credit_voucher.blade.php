        ...
        <div class="page">
            ...
            <div class="body-section" style="margin-top: -10px;">
                <table class="borderless" style="width: 50%; float: left">
                    ...
                    <tr>
                        <th style="text-align:left; width:150px;">Payment From:</th>
                ...
                <table >
                    ...
                    @foreach($voucher->details->items as $item)
                        <tr>
                            <td style="text-align:left;">{{ $item->account_name }} ({{ $item->account_code }}) <br>{{ $item->narration }}</td>
                    ...
                    @endforeach
                    <tr>
                        <td style="text-align:left;">{{ $voucher->details->debit_account_name }} ({{ $voucher->details->debit_account_code }})<br>{{ $voucher->details->items[0]->narration }}</td>
                        <td></td>
                        <td></td>
                        <td></td>
