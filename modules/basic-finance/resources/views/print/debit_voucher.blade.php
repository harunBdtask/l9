            ...
            <div class="body-section" style="margin-top: -10px;">
                <table class="borderless" style="width: 50%; float: left">
                    ...
                    <tr>
                        ...
                        <td style="text-align:left; width:150px;">{{$voucher->bill_no}}</td>
                    </tr>
                    <tr>
                        <th style="text-align:left; width:150px;">Entry Date:</th>
                        <td style="text-align:left; width:150px;">{{ $voucher->created_at ? $voucher->created_at->toFormattedDateString():'' }}</td>
                    </tr>
                    </thead>
                </table>
                <table class="borderless" style="width: 50%">
                    ...
                    <tr>
                        ...
                        <th style="text-align:left; width:150px;">{{$voucher->bank->account->name}}</th>
                    </tr>
                    <tr>
                        <th style="text-align:left; width:150px;">Cheque No:</th>
                        <td style="text-align:left; width:150px;">
                            {{ $voucher->cheque_no ? ($voucher->cheque->chequeBook->cheque_book_no.'-'.$voucher->cheque->cheque_no): ''; }}
                        </td>
                    </tr>
                    <tr>
                        <th style="text-align:left; width:150px;">Due Date:</th>
                        <th style="text-align:left; width:150px;">{{$voucher->cheque_due_date ? $voucher->cheque_due_date : ''}}</th>
                    </tr>
                    <tr>
                ...
                <table>
                    ...
                    @php
                        $currency =  collect(\SkylarkSoft\GoRMG\Finance\Services\CurrencyService::currencies())->where('id', $voucher->details->currency_id)->first()['name'] ?? null;
                    @endphp
                    @foreach($voucher->details->items as $item)
                        <tr>
                            <td style="text-align:left;">{{ $item->account_name }} ({{ $item->account_code }}) </td>
                    ...
                    @endforeach
                    <tr>
                        <td>{{ $voucher->details->credit_account_name }}
                            ({{ $voucher->details->credit_account_code }})
                        </td>
