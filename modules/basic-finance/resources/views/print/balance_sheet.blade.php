        ...
        <div class="page">
            ...
            <div class="body-section" style="margin-top: -10px;">
                <table class="borderless">
                    <thead>
                        <tr>
                            <td class="text-left" style="padding:0px; width:2%; margin: 0px">Report Title:</td>
                            <td class="text-left" style="padding:0px; margin: 0px"><b>{{$report_title }}</b></td>
                        </tr>
                        <tr>
                            <td nowrap class="text-left" style="padding:0px; width:2%; margin: 0px">Date Between:</td>
                            <td nowrap class="text-left" style="padding:0px; margin: 0px"><b>{{$start_date->toFormattedDateString() }} to {{ $end_date->toFormattedDateString() }}</b></td>
                        </tr>
                    </thead>
                </table>
                <br>
