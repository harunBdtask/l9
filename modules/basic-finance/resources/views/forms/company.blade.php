                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                {!! Form::model($company, ['url' => $company ? 'basic-finance/companies/'.$company->id : 'basic-finance/companies', 'method' => $company ? 'PUT' : 'POST', 'files' => true]) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::text('bin', null, ['class' => 'form-control form-control-sm', 'id' => 'bin', 'placeholder' => 'Write company\'s BIN here']) !!}
                                ...
                                <div class="form-group m-t-md">
                                    ...
                                    <a class="btn white" href="{{ url('basic-finance/companies') }}">Cancel</a>
                                </div>
                                {!! Form::close() !!}
                            </div>
                        </div>
