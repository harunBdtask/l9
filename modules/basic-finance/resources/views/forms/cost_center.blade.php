                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                {!! Form::model($costCenter, ['url' => $costCenter ? 'basic-finance/cost-centers/'.$costCenter->id : 'basic-finance/cost-centers', 'method' => $costCenter ? 'PUT' : 'POST', 'files' => true]) !!}
                                ...
                                <div class="form-group m-t-md">
                                    ...
                                    <a class="btn btn-danger" href="{{ url('basic-finance/cost-centers') }}">Cancel</a>
                                </div>
                                {!! Form::close() !!}
                            </div>
                        </div>
