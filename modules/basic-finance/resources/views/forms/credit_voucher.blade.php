        ...
        <div class="table-responsive">
            <table class="table reportTable" id="tabular-form">
                ...
                <tr>
                    ...
                    <th colspan="2" style="width: 30%;">CREDIT</th>
                ...
                <tr>
                    ...
                    <td>
                        <input type="number" name="conversion_rate" class="form-control fontSize" autocomplete="off">
                    </td>
                    <td>
                        <input type="number" name="cr_fc" id="cr_fc" class="form-control fontSize" autocomplete="off">
                    </td>
                    <td>
                        <input type="number" name="cr_bd" id="cr_bd" class="form-control fontSize" autocomplete="off">
                    </td>
                    <td>
        ...
        var CreditVoucher = {
            ...
            submitAndCopyForm: function () {
                ...
                $('#credit-voucher-form .voucher-submit-copy-btn').click(function (event) {
                    ...
                    CreditVoucherCart.department_id = (CreditVoucherCart.items[0] ? CreditVoucherCart.items[0].department_id:'');
                    CreditVoucherCart.department_name = (CreditVoucherCart.items[0] ? CreditVoucherCart.items[0].department_name:'');
                    CreditVoucherCart.const_center = (CreditVoucherCart.items[0] ? CreditVoucherCart.items[0].const_center: '');
                    CreditVoucherCart.const_center_name = (CreditVoucherCart.items[0] ? CreditVoucherCart.items[0].const_center_name: '');
