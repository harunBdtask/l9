...
<input type="hidden" name="type_id"
       value="<?php echo e(\SkylarkSoft\GoRMG\BasicFinance\Models\Voucher::JOURNAL_VOUCHER); ?>">
...
<div class="col-md-4">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            @php
                $bill_no = isset($voucher) ? $voucher->bill_no : null;
            @endphp
            <input type="text" class="form-control" name="bill_no" id="bill_no" value="<?php echo $bill_no; ?>">
        </div>
    </div>
</div>
        ...
        <div class="table-responsive">
            <table class="table reportTable" id="tabular-form">
                ...
                <tr>
                    ...
                    <th class="text-right" rowspan="2" style="width: 15%;">NARRATION</th>
    ...
    var JournalVoucher = {
        ...
        currency: function () {
            $('#journal-voucher-form select[name="currency_id"]').change(function () {
                ...
                if (currency == 1) {
                    $('#journal-voucher-form input[name="conversion_rate"]').val(1).attr('readonly', 'true');
                    $('#journal-voucher-form input[name="dr_fc"]').val(null).attr('readonly', 'true');
                    $('#journal-voucher-form input[name="cr_fc"]').val(null).attr('readonly', 'true');
                    $('#journal-voucher-form input[name="dr_bd"]').val(null).removeAttr('readonly');
                    $('#journal-voucher-form input[name="cr_bd"]').val(null).removeAttr('readonly');
                } else {
                    $('#journal-voucher-form input[name="conversion_rate"]').val(null).removeAttr('readonly');
                    $('#journal-voucher-form input[name="dr_fc"]').val(null).removeAttr('readonly');
                    $('#journal-voucher-form input[name="cr_fc"]').val(null).removeAttr('readonly');
                    $('#journal-voucher-form input[name="dr_bd"]').val(null).attr('readonly', 'true');
                    $('#journal-voucher-form input[name="cr_bd"]').val(null).attr('readonly', 'true');
                }
            });
        },
        ...
        submitAndCopyForm: function () {
            ...
            $('#journal-voucher-form .voucher-submit-copy-btn').click(function (event) {
                ...
                JournalVoucherCart.bill_no = $('#journal-voucher-form input[name="bill_no"]').val();
                ...
                if (voucher.validate()) {
                    ...
                    $.ajax({
                        ...
                        data: {
                            ...
                            bill_no: JournalVoucherCart.bill_no,
        ...
        validateBillNo:function(){
            let voucher = this;
            //Bill no exist checking start
            $("#bill_no").blur(function(){
                    var bill_no = $('#bill_no').val();
                    var type_id = $('#journal-voucher-form input[name="type_id"]').val();
        ...
        init: function () {
            $('#journal-voucher-form #currency_id').val();
