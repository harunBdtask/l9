...
<div class="padding">
    <div class="box">
        ...
        <div class="box-body b-t">
            <div class="row">
                <form action="{{ url('basic-finance/transactions') }}" method="GET">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-1">
                        <div class="form-group">
                            <label>&nbsp;</label>
                            <button class="form-control form-control-sm btn-info">Search</button>
                        </div>
                    </div>
                    ...
                    <table class="reportTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-left"> {{ $trn->voucher->voucher_no }}</td>
                                <td class="text-left">{{ $trn->voucher->type }}</td>
                                <td class="text-left">{{ $trn->voucher->reference_no }}</td>
