    ...
    <script>
        $(document).ready(function () {
            $(document).on('submit', '#form', function (event) {
                ...
                $.ajax({
                    url: "/basic-finance/budget-month-wise-report",
                    type: "post",
                    dataType: "html",
                    data: formData,
                    beforeSend() {
        ...
        $(document).on('click', '#pdf', function () {
            ...
            let link = `{{ url('/basic-finance/budget-month-wise-report-pdf') }}?from_month=${fromMonth}&to_month=${toMonth}&account_id=${accountId}`;
        ...
        $(document).on('click', '#excel', function () {
            ...
            let link = `{{ url('/basic-finance/budget-month-wise-report-excel') }}?from_month=${fromMonth}&to_month=${toMonth}&account_id=${accountId}`;
            window.open(link, '_blank');
        });
        ...
        $('.print').click(function (e) {
            ...
            if (url.includes('?')) {
                url += `&print=true&from_month=${fromMonth}&to_month=${toMonth}&account_id=${accountId}`;
            } else {
                url += `?print=true&from_month=${fromMonth}&to_month=${toMonth}&account_id=${accountId}`;
            }
        ...
        function printPage(sURL) {
            ...
            console.log('oHiddFrame', oHiddFrame);
            ...
            oHiddFrame.src = sURL;
            console.log('oHiddFrame', oHiddFrame.src);
