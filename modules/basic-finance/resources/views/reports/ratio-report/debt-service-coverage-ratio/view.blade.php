...
@section('title','Debt Service Coverage Ratio (DSCR)')
@section('content')
    <style type="text/css">
                ...
                <div class="">
                    <div class="header-section" style="padding-bottom: 0px;">
                        <div class="pull-right" style="margin-bottom: -5%;">
                            <a class="btn"
                               href="/basic-finance/ratio-report/debt-service-coverage-ratio/pdf?{{ Request::getQueryString() }}"><i
                        ...
                        <table style="border: 1px solid black;width: 20%;">
                            ...
                            <tr>
                                <td class="text-center">
                                    <span style="font-size: 12pt; font-weight: bold;">Debt Service Coverage Ratio (DSCR)</span>
                                    <br>
                                </td>
                            </tr>
                            </thead>
                    ...
                    <div class="body-section" style="margin-top: 0;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                @includeIf('basic-finance::reports.ratio-report.debt-service-coverage-ratio.table')
                            </div>
                        </div>
                    </div>
