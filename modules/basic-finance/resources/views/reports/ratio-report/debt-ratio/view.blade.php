...
@section('title','Debt Ratio Report')
@section('content')
    <style type="text/css">
                ...
                <div class="">
                    <div class="header-section" style="padding-bottom: 0px;">
                        <div class="pull-right" style="margin-bottom: -5%;">
                            <a class="btn"
                               href="/basic-finance/ratio-report/debt-ratio/pdf?{{ Request::getQueryString() }}"><i
                        ...
                        <table style="border: 1px solid black;width: 20%;">
                            ...
                            <tr>
                                <td class="text-center">
                                    <span style="font-size: 12pt; font-weight: bold;">Debt Ratio Report</span>
                                    <br>
                                </td>
                            </tr>
                            </thead>
