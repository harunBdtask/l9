...
@section('title','Days Sales Outstanding Ratio Report')
@section('content')
    <style type="text/css">
    ...
    <div class="padding">
        <div class="box">
            <div class="box-header">
                <h2>Days Sales Outstanding Ratio Report</h2>
            </div>
                ...
                <div class="">
                    <div class="header-section" style="padding-bottom: 0px;">
                        <div class="pull-right" style="margin-bottom: -5%;">
                            <a class="btn"
                               href="/basic-finance/ratio-report/days-sales-outstanding-ratio/pdf?{{ Request::getQueryString() }}"><i
                        ...
                        <table style="border: 1px solid black;width: 30%;">
                            ...
                            <tr>
                                <td class="text-center">
                                    <span style="font-size: 12pt; font-weight: bold;">Days Sales Outstanding Ratio Report</span>
                                    <br>
                                </td>
                            </tr>
                            </thead>
