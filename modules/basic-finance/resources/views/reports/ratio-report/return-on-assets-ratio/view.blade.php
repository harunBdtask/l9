...
@section('title','Return On Assets Ratio Report')
@section('content')
    <style type="text/css">
    ...
    <div class="padding">
        <div class="box">
            <div class="box-header">
                <h2>Return On Assets Ratio (ROAR) Report</h2>
            </div>
                        ...
                        <table style="border: 1px solid black;width: 20%;">
                            ...
                            <tr>
                                <td class="text-center">
                                    <span style="font-size: 12pt; font-weight: bold;">Return On Assets Ratio (ROAR) Report</span>
                                    <br>
                                </td>
                            </tr>
                            </thead>
