    ...
    <div class="padding">
        <div class="box">
            ...
            <div id="reportForm" class="box-body b-t">
                {!! Form::open(['url'=>'basic-finance/ledger-v3', 'method'=>'get']) !!}
                @php
                ...
                <div class="form-group row custom-padding">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="col-sm-8">
                            {!! Form::select("account_id", $accounts ?? [], request('account_id') ?? null,["class"=>"form-control c-select select2-input", "id"=>"account_id", 'required']) !!}
                        </div>
                    </div>
                </div>
                <div class="form-group row custom-padding">
                        ...
                        <table style="border: 1px solid black;width: 20%;">
                            ...
                            <tr>
                                <td class="text-center">
                                    <span style="font-size: 14pt; font-weight: bold;">Ledger Details</span>
                                    <br>
                                </td>
                            </tr>
                            </thead>
