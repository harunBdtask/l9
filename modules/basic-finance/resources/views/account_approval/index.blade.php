            ...
            <div class="box-body">
                ...
                <div class="row">
                    @if(request('type')!=='unapproved')
                        <a href="{{ url('/basic-finance/fund-requisition/account-approval/create') }}"
                           class="btn btn-primary btn-sm"><i
                                class="fa fa-plus"></i> Account Approval</a>
                        <a href="{{ url('/basic-finance/fund-requisition/account-approval?type=unapproved') }}"
                           class="btn btn-danger btn-sm"><i
                                class="fa fa-eye"></i> Unapproved</a>
                    @else
                        <a href="{{ url('/basic-finance/fund-requisition/account-approval') }}"
                           class="btn btn-primary btn-sm"><i
                ...
                <div class="col-sm-4">
                    <form action="{{ url('/basic-finance/fund-requisition/account-approval') }}" method="GET">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-xs btn-success"
                                                   href="/basic-finance/fund-requisition/account-approval/create?requisition_no={{collect($approval)->first()->requisition->requisition_no}}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-xs btn-info"
                                               href="/basic-finance/fund-requisition/account-approval/{{collect($approval)->first()
