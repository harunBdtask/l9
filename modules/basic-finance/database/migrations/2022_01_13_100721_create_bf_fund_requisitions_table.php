...
class CreateBfFundRequisitionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bf_fund_requisitions', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('bf_fund_requisitions');
    }
}
