    ...
    <div class="padding">
        <div class="box">
            ...
            <div class="box-body table-responsive b-t">
                <div class="row">
                    {!! Form::open(['url'=>'/commercial/btb-status', 'method'=>'get']) !!}
                    <div class="col-sm-12">
                        <div class="row">
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <label>Company</label>
                                    {!! Form::select('factory', $factories, request()->get('factory')??null, ['class'=>'form-control form-control-sm select2-input', 'id'=>'factory', 'required'=>true]) !!}
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <label>Buyer</label>
                                    {!! Form::select('buyer',$buyers, request()->get('buyer')??null, ['class'=>'form-control form-control-sm select2-input', 'id'=>'buyer']) !!}
                                </div>
                            </div>
                            <div class="col-sm-1">
                            ...
                            <div class="col-sm-12 text-right" style="margin-top: 1%">
                                <a class="btn btn-default" href="{{ url('commercial/btb-status-pdf?'.http_build_query(request()->query())) }}"><i class="fa fa-file-pdf-o"></i></a>
                            </div>
                        </div>
                    </div>
                    {!! Form::close() !!}
                ...
                <div>
                    ...
                    <div>
                        @includeIf('commercial::reports.btb-status.table')
                    </div>
                </div>
            </div>
