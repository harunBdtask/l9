...
@section('title','Yarn Work Order Statement')
@section('styles')
    <style>
    ...
    <div class="padding">
        <div class="box">
            <div class="box-header">
                <h2>Yarn Work Order Statement</h2>
                <div class="clearfix"></div>
            </div>
            <div class="box-body table-responsive b-t">
                <div class="row">
                    {!! Form::open(['url'=>'/commercial/yarn-work-order-statement', 'method'=>'get']) !!}
                    <div class="col-sm-12">
                        <div class="row">
                            <div class="col-sm-2">
                            ...
                            <div class="col-sm-2 text-right" style="margin-top: 1%">
                                <a href="{{ url('commercial/yarn-work-order-statement-pdf') }}"><i class="fa fa-file-pdf-o"></i></a>
                            </div>
                        </div>
                    </div>
                    {!! Form::close() !!}
                ...
                <div>
                    <br>
                    <div>
                        @includeIf('commercial::reports.yarn-work-order-statement.table')
                    </div>
                </div>
            </div>
