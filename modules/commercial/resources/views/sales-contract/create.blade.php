...
@section('title','Sales Contract Entry')
    ...
    <div class="padding">
        ...
        <div class="box" >
            <div class="box-header text-center" >
                <h2 style="font-weight: 400; ">Sales Contract Entry</h2>
            </div>

            <div class="box-body">
                @include('commercial::partials.flash')
                @include('commercial::sales-contract.partials.converted-form-modal')
                @include('commercial::sales-contract.partials.transferred-b2b-lc-modal')

                @include('commercial::sales-contract.partials.form-main')
    ...
    <script>
        $(document).ready(function () {
            ...
            $body.on('change', '#selectedStyle, #selectedPurchaseOrder', async function (e) {
                ...
                try {
                    ...
                    if (TARGET_NAME === 'selectedStyle') {
                        ...
                        $('#selectedPurchaseOrder').val('').trigger('change');
            ...
            $body.on('click', '.close-po', async function () {
                ...
                if (po_ids.length) {
                    const sales_contract_id = $("[name='sales_contract_id']").val();
                    const res = await axios.get(`/get-sales-detail-form-create?ids=${JSON.stringify(po_ids)}&sales_contract_id=${sales_contract_id}`)
