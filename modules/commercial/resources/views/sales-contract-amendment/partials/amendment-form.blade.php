{!! Form::model($contract, ['url' => '/commercial/sc-amendment/' . $contract->id, 'method' => 'post', 'id' => 'form']) !!}
...
<table class="reportTable mainForm">
    ...
    <tr>
        ...
        <th><label for="amendment_date">Amend. Date<span class="text-danger">*</span></label></th>
        <td>
    ...
    <tr>
        <th><label for="amendment_value">Amend. Value<span class="text-danger">*</span></label></th>
        <td>{!! Form::number('amendment_value', null, ['class' => 'form-control form-control-sm form-control form-control-sm-sm', 'id' => 'amendment_value']) !!}</td>
    ...
    <tr>
        ...
        <td>{!! Form::text('claim_adjusted', null, ['class' => 'form-control form-control-sm form-control form-control-sm-sm', 'id' => 'claim_adjustment', 'placeholder' => '']) !!}</td>
    ...
    <tr>
        ...
        <td colspan="3">{!! Form::text('bl_clause', null, ['class' => 'form-control form-control-sm form-control form-control-sm-sm', 'id' => 'bl_clause', 'placeholder' => '']) !!}</td>
    </tr>
