...
<table class="reportTable mainForm">
    ...
    <tr>
        ...
        <td>{!! Form::text('bank_file_no', null, ['class' => 'form-control form-control-sm form-control form-control-sm-sm', 'disabled']) !!}</td>

        <th><label for="contract_number">Contract Number</label></th>
        <td>{!! Form::text('contract_number', null, ['class' => 'form-control form-control-sm form-control form-control-sm-sm', 'disabled']) !!}</td>

    </tr>

    <tr>
        <th><label for="contract_value">Contract Value</label></th>
        <td>{!! Form::text('contract_value', null, ['class' => 'form-control form-control-sm form-control form-control-sm-sm', 'data-parsley-required', 'disabled',  'placeholder' => '']) !!}</td>

        <th><label for="convertible_to">Convertible To</label></th>
        <td>{{ Form::select('convertible_to', \SkylarkSoft\GoRMG\Commercial\Options::CONVERTIBLE_TO, null, ['class' => 'form-control form-control-sm form-control form-control-sm-sm', 'disabled']) }}</td>
    </tr>
    ...
    <tr>
        ...
        <td>{!! Form::date('expiry_date', null, ['class' => 'form-control form-control-sm form-control form-control-sm-sm', 'placeholder' => '',  'disabled']) !!}</td>
    </tr>
    ...
    <tr>
        ...
        <td>{{ Form::select('inco_term', \SkylarkSoft\GoRMG\Commercial\Options::INCO_TERMS, null, ['class' => 'form-control form-control-sm form-control form-control-sm-sm', 'disabled']) }}</td>
    </tr>

    <tr>
        <th><label for="inco_term_place">Inco Term Place</label></th>
        <td>{!! Form::text('inco_term_place', null, ['class' => 'form-control form-control-sm form-control form-control-sm-sm', 'placeholder' => '', 'disabled']) !!}</td>

        <th><label for="contract_source">Contract Source</label></th>
        <td>{{ Form::select('contract_source', \SkylarkSoft\GoRMG\Commercial\Options::CONTACT_SOURCES, null, [ 'class' => 'form-control form-control-sm form-control form-control-sm-sm', 'disabled']) }}</td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="3">{!! Form::text('bl_clause', null, ['class' => 'form-control form-control-sm form-control form-control-sm-sm', 'placeholder' => '', 'disabled']) !!}</td>
    </tr>
