...
@section('title','BTB Status Report')
@section('styles')
    <style>
    ...
    <div class="padding">
        <div class="box">
            <div class="box-header">
                <h2>Primary Contract BTB Status Report</h2>
                <div class="clearfix"></div>
            </div>
            <div class="box-body table-responsive b-t">
                <div class="row">
                    {!! Form::open(['url'=>'/commercial/pmc-btb-status', 'method'=>'get']) !!}
                    <div class="col-sm-12">
                        <div class="row">
                            <div class="col-sm-2">
...
{{--                                </button>--}}
                ...
                <div>
                    <br>
                    <div>
                        @includeIf('commercial::btb-status-report.table')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '#report_excel', function () {
                queryString = `from_date=${fromDate.val()}&to_date=${toDate.val()}`;
                window.location.replace(`/commercial/pmc-btb-status/get-excel?${queryString}`);
            });
        });
