    ...
    <div class="padding">
        ...
        <div class="box" >
            ...
            <div class="box-body">
                ...
                {!! Form::open(['url' => 'commercial/export-lc-amendments/form-create', 'method' => 'post']) !!}
...
{{--                            {{ Form::select('file_no', $fileNo, null, ['class' => 'form-control form-control-sm form-control form-control-sm-sm Select2', 'id' => 'file_no']) }}--}}
{{--                            {!!  Form::text('file_no', null, ['class' => 'form-control form-control-sm form-control form-control-sm-sm', 'id' => 'export_contract_no']) !!}--}}
