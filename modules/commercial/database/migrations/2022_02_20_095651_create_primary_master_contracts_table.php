...
class CreatePrimaryMasterContractsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('primary_master_contracts', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('primary_master_contracts');
    }
}
