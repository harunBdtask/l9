            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header text-center">
                        <h2>DATE WISE / CHALLAN WISE STYLE PRINT SEND RECEIVE DETAILS
                    ...
                    <div class="box-body">
                        {!! Form::open(['url' => '/manual-challan-wise-print-report', 'method' => 'GET', 'id'=>'search_form']) !!}
                        ...
                        {!! Form::close() !!}
                        @include('manual-production::reports.print.includes.challan_wise_print_report_include')
                    </div>
                </div>
            </div>
        </div>
...
@section('scripts')
    <script>
        function submitPdf() {
            $("#search_form").attr('action', '/manual-challan-wise-print-report/pdf').submit();
        }

        function submitExcel() {
            $("#search_form").attr('action', '/manual-challan-wise-print-report/excel').submit();
        }
