...
use SkylarkSoft\GoRMG\ManualProduction\Requests\ManualCuttingProductionRequest;
...
class CuttingProductionController extends Controller
{
    ...
    {
        return view("manual-production::cutting-production.index");
    }

    public function store(ManualCuttingProductionRequest $request): JsonResponse
    {
        try {
            DB::beginTransaction();
            ...
            $sub_cutting_floor_id = $request->sub_cutting_floor_id ?? null;
            $sub_cutting_table_id = $request->sub_cutting_table_id ?? null;
            $no_of_bundles = $request->no_of_bundles ?? null;
            ...
            if ($size_id && is_array($size_id) && count($size_id) && $production_qty && is_array($production_qty)) {
                ...
                foreach ($size_id as $size_key => $s_id) {
                    ...
                    $individual_no_of_bundles = array_key_exists($size_key, $no_of_bundles) ? $no_of_bundles[$size_key] : 0;
                    ...
                    $manual_cutting_production = new ManualCuttingProduction([
                        ...
                        'sub_cutting_floor_id' => $sub_cutting_floor_id,
                        'sub_cutting_table_id' => $sub_cutting_table_id,
                        'no_of_bundles' => isset($individual_no_of_bundles) ? $individual_no_of_bundles : 0,
                    ...
                    $manual_cutting_production->save();
                }
                ...
                foreach ($color_id as $color_key => $c_id) {
                    ...
                    $individual_no_of_bundles = array_key_exists($color_key, $no_of_bundles) ? $no_of_bundles[$color_key] : 0;
                ...
                $manual_cutting_production = new ManualCuttingProduction([
                    ...
                    'sub_cutting_floor_id' => $sub_cutting_floor_id,
                    'sub_cutting_table_id' => $sub_cutting_table_id,
                    'no_of_bundles' => isset($no_of_bundles) ? $no_of_bundles : 0,
