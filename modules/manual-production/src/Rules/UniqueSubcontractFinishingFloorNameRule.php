...
class UniqueSubcontractFinishingFloorNameRule implements Rule
{
    ...
    public function passes($attribute, $value)
    {
        ...
        $floor = SubcontractFinishingFloor::where('floor_name', $value)
    ...
    {
        return "Duplicate finishing floor found in $this->factory_name!";
    }
}
