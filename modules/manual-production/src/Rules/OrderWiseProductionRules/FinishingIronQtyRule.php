...
class FinishingIronQtyRule implements Rule
{
    ...
    {
        return "The production qty $this->production_qty cannot be greater than iron balance qty  $this->remaining_qty till $this->production_date .";
    }
}
