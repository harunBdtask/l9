...
class InspectionQtyRule implements Rule
{
    ...
    {
        return "The production qty $this->production_qty cannot be greater than inspection balance qty  $this->remaining_qty till $this->production_date .";
    }
}
