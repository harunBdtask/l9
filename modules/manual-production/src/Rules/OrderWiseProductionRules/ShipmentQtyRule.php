...
class ShipmentQtyRule implements Rule
{
    ...
    public function passes($attribute, $value)
    {
        ...
        $prev_date_production_qty = ManualPolyPackingProduction::query()
    ...
    {
        return "The production qty $this->production_qty cannot be greater than shipment balance qty  $this->remaining_qty till $this->production_date .";
    }
}
