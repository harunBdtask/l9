...
class UniqueSubcontractSewingFloorNameRule implements Rule
{
    ...
    public function passes($attribute, $value)
    {
        ...
        $floor = SubcontractSewingFloor::where('floor_name', $value)
    ...
    {
        return "Duplicate sewing floor found in $this->factory_name!";
    }
}
