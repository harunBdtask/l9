...
class UniqueSubcontractEmbellishmentFloorNameRule implements Rule
{
    ...
    public function passes($attribute, $value)
    {
        ...
        $floor = SubcontractEmbellishmentFloor::where('floor_name', $value)
    ...
    {
        return "Duplicate embellishment floor found in $this->factory_name!";
    }
}
