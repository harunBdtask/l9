...
class CreateManualDailyProductionReportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('manual_daily_production_reports', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('manual_daily_production_reports');
    }
}
