...
class CreateManualEmblReceiveProductionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('manual_embl_receive_productions', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('manual_embl_receive_productions');
    }
}
