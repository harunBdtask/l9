...
class CreateManualDateWisePrintEmbrReportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('manual_date_wise_print_embr_reports', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('manual_date_wise_print_embr_reports');
    }
}
