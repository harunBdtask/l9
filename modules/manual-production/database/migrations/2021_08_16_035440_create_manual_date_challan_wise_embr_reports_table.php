...
class CreateManualDateChallanWiseEmbrReportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('manual_date_challan_wise_embr_reports', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('manual_date_challan_wise_embr_reports');
    }
}
