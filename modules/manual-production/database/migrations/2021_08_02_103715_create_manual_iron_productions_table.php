...
class CreateManualIronProductionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('manual_iron_productions', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedInteger('re_iron_qty')->default(0);
    ...
    {
        Schema::dropIfExists('manual_iron_productions');
    }
}
