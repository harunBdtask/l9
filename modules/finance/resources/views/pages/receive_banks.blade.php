        ...
        <div class="box">
            ...
            <div class="box-body b-t">
                <div style="margin-bottom: 15px">
                    ...
                    <a class="btn btn-sm white" href="{{ url('finance/receive-banks/create') }}">
                        <i class="glyphicon glyphicon-plus"></i> New Receive Bank
                    </a>
                    @endpermission
                    <div class="pull-right" style="width: 40%">
                        <form action="{{ url('finance/receive-banks') }}" method="GET">
                        ...
                        <tr class="tr-height">
                            ...
                            <td>
                                ...
                                <a class="btn btn-xs btn-success"
                                   href="{{ url('finance/receive-banks/'.$bank->id.'/edit') }}">
