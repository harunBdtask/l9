        ...
        <div class="box">
            ...
            <div class="box-body b-t">
                <div style="margin-bottom: 15px">
                    <a class="btn btn-sm white" href="{{ url('finance/cheque-books/create') }}">
                        <i class="glyphicon glyphicon-plus"></i> New Cheque Book
                    </a>
                    <div class="pull-right" style="width: 40%">
                        <form action="{{ url('finance/cheque-books') }}" method="GET">
                        ...
                        <tr class="tr-height">
                            ...
                            <td>
                                <a class="btn btn-xs btn-success"
                                   href="{{ url('finance/cheque-books/'.$cheque_book->id.'/edit') }}">
                                    <i class="fa fa-edit"></i>
                                </a>
                                <a href="{{ url('finance/cheque-books/'.$cheque_book->id.'/view') }}"
                                   class="btn btn-xs btn-primary">
                                    <i class="fa fa-eye"></i>
                                </a>
{{--                                {{ Form::open(['url' => "finance/cheque-books/$cheque_book->id", 'method'=>'DELETE'])  }}--}}
...
{{--                                {{ Form::close()  }}--}}
                                <button style="margin-left: 2px;" type="button"
                                        ...
                                        ui-target="#animate"
                                        data-url="{{ url('/finance/cheque-books/'.$cheque_book->id. '/delete') }}">
                                    <i class="fa fa-trash"></i>
                                </button>
                            </td>
                        </tr>
                    @empty
                        <tr class="tr-height">
                            <td colspan="12" class="text-center text-danger">No Account Found</td>
                        </tr>
                    @endforelse
                    </tbody>
                    <tfoot>
