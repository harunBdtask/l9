        ...
        <div class="box">
            ...
            <div class="box-body b-t">
                <div style="margin-bottom: 15px">
                    ...
                    <a class="btn btn-sm white" href="{{ url('finance/banks/create') }}">
                        <i class="glyphicon glyphicon-plus"></i> New Bank
                    </a>
                    @endpermission
                    <div class="pull-right" style="width: 40%">
                        <form action="{{ url('finance/banks') }}" method="GET">
                ...
                <table class="reportTable">
                    ...
                    @forelse($banks as $bank)
                        @php
                            $contractPersons = collect($bank->bankContacts)->pluck('name')->join(', ');
                            $contractNumbers = collect($bank->bankContacts)->pluck('contract_number')->join(', ');
                            $contractEmails = collect($bank->bankContacts)->pluck('email')->join(', ');
                        @endphp
                        <tr class="tr-height">
...
{{--                            @endif--}}
                            <td>
                                ...
                                <a class="btn btn-xs btn-success"
                                   href="{{ url('finance/banks/create?id=' . $bank->id) }}">
...
{{--                                {{ Form::open(['url' => "finance/banks/$bank->id", 'method'=>'DELETE'])  }}--}}
