        ...
        <div class="box">
            ...
            <div class="box-body table-responsive b-t">
                <div class="box-body">
                    ...
                    <a class="btn btn-sm white m-b" href="{{ url('finance/cost-centers/create') }}">
                        ...
                        @foreach($costCenters as $costCenter)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{url('finance/cost-centers/'.$costCenter->id.'/edit')}}" class="btn btn-xs btn-success" data-toggle="tooltip" data-placement="top" title="Edit"><i
                                    ...
                                    <button type="button" class="btn btn-xs btn-danger show-modal" data-toggle="modal"
                                            ...
                                            data-url="{{ url('finance/cost-centers/'.$costCenter->id) }}">
                    ...
                    @if($costCenters->total() > 15)
                        <tr>
                            <td colspan="4" align="center">
                                {{ $costCenters->appends(request()->except('page'))->links() }}
                            </td>
                        </tr>
                    @endif
                    </tfoot>
