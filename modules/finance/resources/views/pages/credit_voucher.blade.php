            ...
            <div class="box-body b-t">
                <div class="voucher-meta">
                    <div class="col-md-4 col-md-offset-1">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-4 form-control-label text-right"><b>Pay-mode : </b></label>
                            <div class="col-sm-8 form-control-label text-left">
                                <p>{{  $voucher->paymode == 1 ? 'Bank' : 'Cash' }}</p>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-4 form-control-label text-right"><b>To : </b></label>
                            <div class="col-sm-8 form-control-label text-left">
                                <p>{{  $voucher->to ?? '--' }}</p>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group row">
                            <label class="col-sm-7 form-control-label text-right"><b>Cheque No : </b></label>
                            <div class="col-sm-5 form-control-label text-left">
                                <p>{{  $voucher->cheque_no ?? '--' }}</p>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-7 form-control-label text-right"><b>Cheque Date : </b></label>
                            <div class="col-sm-5 form-control-label text-left">
                                <p>{{  $voucher->cheque_date ?? '--' }}</p>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-7 form-control-label text-right"><b>Cheque Due Date : </b></label>
                            <div class="col-sm-5 form-control-label text-left">
                                <p>{{  $voucher->cheque_due_date ?? '--' }}</p>
                            </div>
                        </div>
                        <div class="form-group row">
                    ...
                    <table class="table table-bordered" id="tabular-form">
                        ...
                        @foreach($voucher->details->items as $item)
                            <tr>
                                ...
                                <td>{{ $item->unit_name??null }}</td>
                                <td>{{ $item->const_center_name }}</td>
                                <td>{{ $item->currency_name . '@' . $item->conversion_rate }}</td>
                                <td class="text-right"></td>
                                <td class="text-right">{{ isset($item->cr_fc) && $item->cr_fc != 0 ? number_format($item->cr_fc, 2) : '' }}</td>
                                <td class="text-right"></td>
                                <td class="text-right">{{ isset($item->credit) && $item->credit != 0 ? number_format($item->credit, 2) : '' }}</td>
                            </tr>
                        @endforeach
                        <tr>
                            <td>{{ $voucher->details->debit_account_code??null }}</td>
                            <td>{{ $voucher->details->debit_account_name??null }}</td>
                            <td>{{ $voucher->details->items[0]->narration }}</td>
                            <td></td>
                            <td></td>
                            <td></td>
                            <td class="text-right">
                            ...
                            <td class="text-right"></td>
                            <td class="text-right">{{ $voucher->details->total_debit != 0 ? number_format($voucher->details->total_debit, 2) : '' }}</td>
                            <td class="text-right"></td>
                        </tr>
                        <tr>
