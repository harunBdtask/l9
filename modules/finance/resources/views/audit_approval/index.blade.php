                ...
                <div class="row">
                    <div class="col-sm-4">
                        @if(request('type')!=='unapproved')
                            <a href="{{ url('/finance/fund-requisition/audit-approval/create') }}"
                               class="btn btn-primary btn-sm"><i
                                    class="fa fa-plus"></i> Audit Approval</a>
                            <a href="{{ url('/finance/fund-requisition/audit-approval?type=unapproved') }}"
                               class="btn btn-danger btn-sm"><i
                                    class="fa fa-eye"></i> Unapproved</a>
                        @else
                            <a href="{{ url('/finance/fund-requisition/audit-approval') }}"
                               class="btn btn-primary btn-sm"><i
                    ...
                    <div class="col-sm-4">
                        <form action="{{ url('/finance/fund-requisition/audit-approval') }}" method="GET">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-xs btn-success"
                                                   href="/finance/fund-requisition/audit-approval/create?requisition_no={{collect($approval)->first()->requisition->requisition_no}}">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-xs btn-info"
                                                   href="/finance/fund-requisition/audit-approval/{{collect($approval)
