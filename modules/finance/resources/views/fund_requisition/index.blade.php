    ...
    <div class="padding">
        <div class="box" style="min-height: 610px">
            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <a href="{{ url('/finance/fund-requisition/create') }}" class="btn  btn-primary btn-sm"><i
                                class="fa fa-plus"></i> New Fund Requisition</a>
                    </div>
                    <div class="col-sm-4 col-sm-offset-2">
                        <form action="{{ url('/finance/fund-requisition') }}" method="GET">
                        ...
                        <table class="reportTable">
                            ...
                            @foreach($requisitions as $index=>$requisition)
                                <tr>
                                    ...
                                    <td>
                                        <p>{{$requisition->is_approved ? 'APPROVED' : 'UNAPPROVED'}}</p>
                                    </td>
                                    <td>
                                        <a class="btn btn-xs btn-info"
                                           href="/finance/fund-requisition/{{$requisition->id}}"><i
                                                class="fa fa-eye"></i></a>
                                        <button type="button" class="btn btn-xs btn-danger show-modal"
                                                data-toggle="modal"
                                                data-target="#confirmationModal" ui-toggle-class="flip-x"
                                                ui-target="#animate"
                                                data-url="{{ url('finance/fund-requisition/'.$requisition->id) }}">
