        ...
        <div class="box" style="min-height: 610px">
            ...
            <div class="box-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <form action="{{ url('/finance/fund-requisition/account-approval/create') }}" method="GET">
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                  <button class="btn btn-success" type="submit"><i class="fa fa-search"></i></button>
                                    <a href="/finance/fund-requisition/account-approval" class="btn btn-danger"><i
                ...
                <div class="row m-t">
                    <div class="col-sm-12">
                        @if(count($requisitionDetails)>0)
                            <form action="/finance/fund-requisition/account-approval" method="post">
                                @csrf
                                ...
                                <div class="text-center btn-groups">
                                    ...
                                    <a href="/finance/fund-requisition/account-approval/create"
