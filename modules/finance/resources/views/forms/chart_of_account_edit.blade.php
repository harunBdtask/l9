...
@section('title', 'Update Chart of Account')
@section('content')
    <div class="padding">
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div class="box">
                    ...
                    <div class="box-body">
                        {{ Form::open(['url' => '/finance/api/v1/update-ledger-account/'.$account->id, 'method' => 'put', 'id' => 'account_form']) }}

                        <input type="hidden" name="id" class="" value="{{ $account?$account->id:'0' }}">
                        <input type="hidden" name="account_type" class="account_type" value="{{ $account?$account->account_type:'4' }}">
                        <div class="form-group row account_type">
                            <label class="col-sm-3" for="type_id" class="col-sm-3">Type Of A/C<span class="text-danger">*</span></label>
                            <div class="col-sm-7">
                                {!! Form::select('type_id_1', $ac_types, $account?$account->type_id:null, ['class' => 'form-control form-control-sm c-select select2-input', 'disabled', 'id' => 'type', 'required'=>true, 'placeholder' => 'Select account type']) !!}
                                <input type="hidden" name="type_id" id="type_id" value="{{ $account?$account->type_id:null }}">
                                <span class="text-danger">{{ $errors->first('type_id') }}</span>
                            </div>
                        </div>

                        <div class="form-group row parent_account">
                            <label class="col-sm-3" for="parent_ac">Parent Name<span class="text-danger">*</span></label>
                            <div class="col-sm-7">
                                {!! Form::select('parent_account_id_1', [], null, ['class' => 'form-control form-control-sm parent-account', 'id' => 'parent_ac', 'disabled', 'required'=>true, 'placeholder' => 'Select parent account if any']) !!}
                                <input type="hidden" name="parent_account_id" id="parent_account_id" value="{{ $account?$account->accountInfo->parent_account_id:null }}">
                        ...
                        <div class="form-group row group_account">
                            <label class="col-sm-3" for="parent_ac">Group Name<span class="text-danger">*</span></label>
                            <div class="col-sm-7">
                                {!! Form::select('group_account_id_1', [], $account->accountInfo->group_account_id??null, ['class' => 'form-control form-control-sm group_account',  'disabled', 'id' => 'group_ac', 'required'=>true, 'placeholder' => 'Select']) !!}
                                <input type="hidden" name="group_account_id" id="group_account_id" value="{{ $account?$account->accountInfo->group_account_id:null }}">
                        ...
                        <div class="form-group row control_account">
                            <label class="col-sm-3" for="parent_ac">Control Ledger<span class="text-danger">*</span></label>
                            <div class="col-sm-7">
                                {!! Form::select('control_account_id_1', [], null, ['class' => 'form-control form-control-sm control_account', 'id' => 'control_ac', 'disabled', 'required'=>true, 'placeholder' => 'Select']) !!}
                                <input type="hidden" name="control_account_id" id="control_account_id" value="{{ $account?$account->accountInfo->control_account_id:null }}">
...
{{--                        </div>--}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="ledger_option">
                                <div class="col-sm-7">
                                    {!! Form::text('name_1', $account->account_type>3?$account->name:null, ['class' => 'form-control form-control-sm', 'id' => 'ledger', ($account->account_type<=3?'readonly':''), 'placeholder' => 'Select']) !!}
                                    <input type="hidden" name="name" id="name" value="{{ $account?$account->name:null }}">
...
{{--                                </div>--}}
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3" for="parent_ac">Ac
                                Code</label>
                            <div class="col-sm-7">
                                {!! Form::text('code', isset($account)?$account->code:null, ['class' => 'form-control form-control-sm', 'placeholder' => 'Ac Code', 'readonly' => true]) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3" for="parent_ac">Status</label>
                            <div class="col-sm-7">
                                {!! Form::select('status', $status ?? [], isset($account)?$account->status:null, ['class' => 'form-control form-control-sm c-select select2-input', 'readonly' => true]) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                {!! Form::select('is_transactional', [1 => 'Yes', 0 => 'No'], isset($account)?$account->is_transactional:null, ['class' => 'form-control form-control-sm c-select select2-input', 'readonly' => true]) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group m-t-md row">
                            <div class="col-sm-7 col-sm-offset-3">
                                <button type="submit" class="btn btn-sm btn-info"><i
                                    class="fa fa-save"></i> {{ isset($account) ? 'Update' : 'Create' }}</button>
...
`)
        ...
        $(document).on('change', '#parent_ac', function () {
            $.ajax({
                ...
                @if($account)
                $('#group_ac').val({{ $account->accountInfo->group_account_id??0 }}).trigger("change");
                @endif
            })
        })
        ...
        $(document).on('change', '#group_ac', function () {
            $.ajax({
                ...
                @if($account)
                $('#control_ac').val({{ $account->account_type==3?$account->id:$account->accountInfo->control_account_id }}).trigger("change");
                @endif
        ...
        @if($account)
            ...
            setNextAccount(@php echo $parents @endphp, 'parent_ac');

            $('#parent_ac').val({{ $account->accountInfo->parent_account_id??0 }}).trigger("change");

             //If it's ledger account
