            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                {!! Form::model($project, ['url' => $project ? 'finance/projects/'.$project->id : 'finance/projects', 'method' => $project ? 'PUT' : 'POST', 'files' => true]) !!}
                                ...
                                <div class="form-group m-t-md">
                                    ...
                                    <a class="btn btn-danger" href="{{ url('finance/projects') }}">Cancel</a>
                                </div>
                                {!! Form::close() !!}
                            </div>
                        </div>
