    ...
    <div class="padding">
        <div class="box">
            ...
            <div class="box-body b-t">
                <div class="row">
                    <form id="form" action="{{ url('finance/vouchers-approve-panels') }}" method="GET">
                        <div class="col-md-12">
                            <div class="col-md-3">
                        ...
                        <div class="col-md-12">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    {!! Form::date('from_date', request('from_date') ?? null, [
                                        'class' => 'form-control select2-input', 'placeholder' => 'Select'
                                    ]) !!}
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>To Date</label>
                                    {!! Form::date('to_date', request('to_date') ?? null, [
                                        'class' => 'form-control select2-input', 'placeholder' => 'Select'
                                    ]) !!}
                                </div>
                            </div>
                ...
                <div class="form-group row">
                    <div class="col-lg-12">
                        @includeIf('finance::forms.approvals.unapprove_vouchers')
                        <br>
                        <br>
                        @includeIf('finance::forms.approvals.approve_vouchers')
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on('click', '#post', function () {
                ...
                url += `/finance/vouchers/${id}/approval`;
            ...
            $(document).on('click', '#posts', function (event) {
                ...
                axios.post(`/finance/multiple-vouchers-posting`, vouchers).then((response) => {
        ...
        function getProjects(factoryId) {
            axios.get(`/finance/api/v1/fetch-company-wise-projects/${factoryId}`).then((response) => {
        ...
        function getUnits(factoryId, projectId) {
            axios.get(`/finance/api/v1/fetch-project-wise-units/${factoryId}/${projectId}`).then((response) => {
