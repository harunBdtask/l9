        ...
        <div class="table-responsive">
            <table class="table reportTable" id="tabular-form">
                ...
                <tr>
                    ...
                    <th class="text-right" style="width: 30%;" rowspan="2">NARRATION</th>
                ...
                <tr>
                        ...
                        <select class="form-control c-select select2-input" name="account" id="account">
                            ...
                            @else
                                <option value="{{ $account->id }}" data-id="{{ $account->id }}"
                                        ...
                                        data-code="{{ $account->code }}">
                                    {{ $account->name }} - ({{ $account->accountInfo->controlAccount->name }})
                                </option>
                            @endif
                    ...
                    <td>
                        <input type="number" name="dr_fc" id="dr_fc" class="form-control" autocomplete="off">
                    </td>
                    <td>
                        <input type="number" name="dr_bd" id="dr_bd" class="form-control" autocomplete="off">
                    </td>
                    <td>
