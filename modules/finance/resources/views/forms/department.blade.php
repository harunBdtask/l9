                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                {!! Form::model($department, ['url' => $department ? 'finance/departments/'.$department->id : 'finance/departments', 'method' => $department ? 'PUT' : 'POST', 'files' => true]) !!}
                                ...
                                <div class="form-group m-t-md">
                                    ...
                                    <a class="btn btn-danger" href="{{ url('finance/departments') }}">Cancel</a>
                                </div>
                                {!! Form::close() !!}
                            </div>
                        </div>
