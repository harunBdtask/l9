            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-lg-12">
                                {!! Form::model($bank ?? null, ['url' => isset($bank) ? 'finance/receive-banks/'.$bank->id : 'finance/receive-banks', 'method' => isset($bank) ? 'PUT' : 'POST']) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="button" class="btn btn-sm btn-danger">
                                        <a href="{{ url('finance/receive-banks') }}">Cancel</a>
                                    </button>
                                </div>
                                {!! Form::close() !!}
                            </div>
