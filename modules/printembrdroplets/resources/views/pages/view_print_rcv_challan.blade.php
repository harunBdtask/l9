...
@endsection
@section('title', 'Factory Receive Challan')
@section('content')
  <div class="padding">
    <div class="row">
      <div class="col-md-12">
        <div class="single-challan-row">
          <div class="box">
            <div class="box-header text-center">
              <span style="font-size: 18px; font-weight: bold;">Factory Receive Challan</span>
            ...
            <div class="box-body">
              ...
              <div class="col-sm-12 text-center" style="margin-bottom: 20px;">
                <div class="row">
                  <div class="col-sm-12">
                    <strong>{{ ($challanOrTag->type == 0) ? 'Challan' : 'Tag' }}
                      No: </strong> {{ $challanOrTag->challan_no ?? '' }}
                ...
                <div class="row">
                  <div class="col-sm-12">
                    ...
                    | <strong>Table No.: </strong> {{ $challanOrTag->print_table->name ?? '' }}
                    | <strong>Date
                        ...
                        @foreach($groupByPurchaseOrder->groupBy('color_id') as $groupByColor)
                          ...
                          <tr>
                            ...
                            @if(!in_array($groupByOrder->first()->order_id, $order_ids))
                              <td rowspan="{{ $groupByOrder->groupBy('purchase_order_id')->count() * $groupByPurchaseOrder->groupBy('color_id')->count() }}">{{ $groupByOrder->first()->order->total_quantity ?? 0 }}</td>
                            @endif
