        ...
        <div class="single-challan-row">
          <div class="box">
            <div class="box-header text-center">
              <span style="font-size: 18px; font-weight: bold;">Print Factory Delivery Challan</span>
              ...
              @if($gatePassChallan)
                <table align="center" class="autorized_table">
                  <tr class="text-center" style="font-weight: bold">
                    <td>Prepared By</td>
                    <td>Print/Embr. In Charge</td>
                    <td>Print/Embr. Manager</td>
                    <td>Cutting Received</td>
                  </tr>
                </table>
              @endif
            </div>
