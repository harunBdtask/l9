...
@section('title', 'Date Wise Print/Embr. Sent & Received Summary')
@section('content')
<div class="padding">
  <div class="row">
    <div class="col-md-12">
      <div class="box">
        <div class="box-header text-center">
          <h2>Date Wise Print/Embr. Sent & Received Summary
            <span class="pull-right">
              ...
              |
              <a
                href="{{url('date-wise-print-send-report-download?type=xls&from_date='.($from_date ?? null).'&to_date='.($to_date ?? null))}}">
        ...
        <div class="box-body">
          {!! Form::open(['url' => '/date-wise-print-send-report', 'method' => 'get']) !!}
...
// For each page, print the page number and the total pages
      ...
      for (var i = 1; i <= pageCount; i++) {
        ...
        doc.text(300, 60, "Date Wise Print/Embr. Send Receive Summary " + '(' + moment().format("MMMM Do YYYY") + ')');
      }
      ...
      doc.save('Date_Wise_Print_Embr_Send_Receive_Summary.pdf');
    }
