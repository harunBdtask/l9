...
class CreateArchivedPrintInventoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('archived_print_inventories', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('archived_print_inventories');
    }
}
