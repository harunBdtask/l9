...
namespace SkylarkSoft\GoRMG\Printembrdroplets;
...
use SkylarkSoft\GoRMG\Printembrdroplets\Observers\PrintInventoryChallanObserver;
use SkylarkSoft\GoRMG\Printembrdroplets\Observers\PrintInventoryObserver;
...
class ServiceProvider extends LaravelProvider
{
    ...
    public function boot()
    {
        ...
        PrintInventory::observe(PrintInventoryObserver::class);
        PrintInventoryChallan::observe(PrintInventoryChallanObserver::class);
    }
