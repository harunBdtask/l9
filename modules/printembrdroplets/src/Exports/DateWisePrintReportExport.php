...
class DateWisePrintReportExport implements WithTitle, ShouldAutoSize, FromView, ShouldQueue, WithEvents
{
    use Exportable;
    ...
    {
        return 'Date Wise Print Delivery Report';
    }
    ...
    public function view(): View
    {
        ...
        return view('printembrdroplets::reports.downloads.excel.date-wise-print-send-receive-report-download', $data);
    }
