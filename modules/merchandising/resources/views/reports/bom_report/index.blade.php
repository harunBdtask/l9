                ...
                <div id="reportDiv" hidden>
                    <div class="header-section" style="padding-bottom: 0px;">
                        <div class="pull-right" style="margin-bottom: -5%;">
                            {{--                            <a id="bom_print" class="btn print"--}}
...
@section('scripts')
    <script>
        ...
        $('#order_pdf').click(function (e) {
            e.preventDefault();
            let style_id = $("#style_id").val();
            window.location.replace('/bom-report-fetch?type=pdf&style_id=' + style_id);
        })

        $('#bom_print').click(function (e) {
            e.preventDefault();
            let style_id = $("#style_id").val();
            let link = '/bom-report-fetch?type=print&style_id=' + style_id;
            printPage(link);
        });
