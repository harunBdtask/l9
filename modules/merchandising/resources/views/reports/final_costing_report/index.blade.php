...
@section('title','Final Costing Report')
@section('content')
    <style>
    ...
    <div class="padding">
        <div class="box">
            <div class="box-header">
                <h2>Final Costing Report</h2>
                <div class="clearfix"></div>
            </div>
            <div class="box-body table-responsive b-t">
                <div class="row">
                    <form action="/final-costing-report/get-report" method="post" id="reportForm">
                        <div class="col-sm-12">
                            <div class="row">
                                <div class="col-sm-2">
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control form-control-sm " name="unique_id" readonly
                                               id="unique_id">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(document).on('submit', '#reportForm', function (e) {
                ...
                reportTable.empty();
                $.ajax({
                    url: "/final-costing-report/get-report",
                    type: "get",
                    dataType: "html",
                    data: formData,
                    beforeSend() {
            ...
            $(document).on('click', '#report_pdf', function () {
                ...
                window.open(`/final-costing-report/get-report-pdf?${queryString}`, '_blank')
            });
            ...
            $(document).on('click', '#report_excel', function () {
                ...
                window.location.replace(`/final-costing-report/get-report-excel?${queryString}`);
            });
        });
