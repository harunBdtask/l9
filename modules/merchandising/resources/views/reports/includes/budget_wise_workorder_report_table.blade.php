<div class="row">
    <div style="width: 50%">
        <table class="borderless">
            ...
            <tr>
                <td><b>Order Qty :</b></td>
                <td>{{ round($total_qty) }}</td>
            </tr>
            <tr>
                <td><b>Order Value :</b></td>
                <td>{{ number_format($total_fob_value, 2) }}</td>
            </tr>
            </tbody>
        </table>
    </div>
    ...
    @if(isset($fabricPurchaseDetails['details']))
        ...
        <tr>
            ...
            <td style="background-color: gainsboro;">
                {{--                            <b>{{ round($fabricPurchaseDetails['total_budget_qty'] ?? 0) }}</b>--}}
            </td>
            ...
            <td style="background-color: gainsboro;">
                {{--                            <b>{{ round($fabricPurchaseDetails['total_booking_qty'] ?? 0) }}</b>--}}
            </td>
            <td style="background-color: gainsboro;text-align: right;
            ...
            <td style="background-color: gainsboro;">
                {{--                            <b>{{ round($fabricPurchaseDetails['total_balance_qty'] ?? 0) }}</b>--}}
            </td>
            <td style="background-color: gainsboro;text-align: right;
...
<table class="reportTable">
    ...
    @if(isset($fabricProductionDetails['details']))
        ...
        <tr>
            <td style="background-color: gainsboro" colspan="2"><b>Total</b></td>
            <td style="background-color: gainsboro;">
                {{--                <b>{{ round($fabricProductionDetails['total_budget_qty'] ?? 0) }}</b>--}}
            </td>
            <td style="background-color: gainsboro;text-align: right;
            ...
            <td style="background-color: gainsboro;">
                {{--                <b>{{ round($fabricProductionDetails['total_booking_qty'] ?? 0) }}</b>--}}
            </td>
            <td style="background-color: gainsboro;text-align: right;
            ...
            <td style="background-color: gainsboro;">
                {{--                <b>{{ round($fabricProductionDetails['total_balance_qty'] ?? 0) }}</b>--}}
            </td>
            <td style="background-color: gainsboro;text-align: right;
...
<table class="reportTable">
    ...
    @if(isset($trimsDetails['details']))
        ...
        <tr>
            <td style="background-color: gainsboro" colspan="2"><b>Total</b></td>
            <td style="background-color: gainsboro; color: {{$trimsDetails['total_budget_qty'] < 0 ? 'red' : 'black'}}">
                {{--                <b>{{ round($trimsDetails['total_budget_qty']) }}</b>--}}
            </td>
            ...
            <td style="background-color: gainsboro; color: {{$trimsDetails['total_booking_qty'] < 0 ? 'red' : 'black'}}">
                {{--                <b>{{ round($trimsDetails['total_booking_qty']) }}</b>--}}
            </td>
            ...
            <td style="background-color: gainsboro; color: {{$trimsDetails['total_balance_qty'] < 0 ? 'red' : 'black'}}">
                {{--                <b>{{ round($trimsDetails['total_balance_qty']) }}</b>--}}
            </td>
...
<table class="reportTable">
    ...
    <tbody>
    @forelse($otherDetails as $otherDetail)
        <tr>
            <td>{{ str_pad($loop->iteration, 2, '0', STR_PAD_LEFT) }}</td>
        ...
        @if($loop->last)
            ...
            <tr>
                <td style="background-color: gainsboro" colspan="2"><b>Total</b></td>
                <td style="background-color: gainsboro; color: {{ collect($otherDetails)->sum('budget_qty') < 0 ? 'red' : 'black' }}">
                    {{--                    <b>{{ round(collect($otherDetails)->sum('budget_qty')) }}</b>--}}
                </td>
                ...
                <td style="background-color: gainsboro;color: {{ collect($otherDetails)->sum('booking_qty') < 0 ? 'red' : 'black' }}">
                    {{--                    <b>{{ round(collect($otherDetails)->sum('booking_qty')) }}</b>--}}
                </td>
                ...
                <td style="background-color: gainsboro;color: {{ collect($otherDetails)->sum('balance_qty') < 0 ? 'red' : 'black' }}">
                    {{--                    <b>{{ round(collect($otherDetails)->sum('balance_qty')) }}</b>--}}
                </td>
...
<div class="col-md-8 col-md-offset-2">
    <table class="reportTable">
        ...
        <tr>
            ...
            <td style="text-align: right;"><b>{{ number_format($total_fob_value, 2) }}</b></td>
        </tr>
        <tr>
            <td class="text-left"><b>Fabric(Purchase) Cost</b></td>
            <td style="text-align: right;"><b>{{ number_format($fabricPurchaseDetails['total_budget_value'], 2) }}</b>
            </td>
        </tr>
        <tr>
            <td class="text-left"><b>Yarn Cost</b></td>
            <td style="text-align: right;"><b>{{ number_format($fabricProductionDetails['total_budget_value'], 2) }}</b>
            </td>
        </tr>
        <tr>
            <td class="text-left"><b>Trims Cost</b></td>
            <td style="text-align: right;"><b>{{ number_format($trimsDetails['total_budget_value'], 2) }}</b></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="text-align: right;">
                <b>{{ number_format(collect($otherDetails)->where('type', 'wash')->sum('budget_value'), 2) }}</b></td>
        </tr>
        <tr>
            <td class="text-left"><b>Commercial Cost</b></td>
            <td style="text-align: right;">
                <b>{{ number_format($budgetCommercialCost, 2) }}</b></td>
        </tr>

        <tr>
            <td class="text-left"><b>Other Cost</b></td>
            <td style="text-align: right;"><b>{{ number_format($budgetOthersCosting, 2) }}</b></td>
        </tr>
        <tr>
            <td colspan="2"></td>
        </tr>
