<div class="col-md-10 col-md-offset-1">
    @if(isset($reportData))
        <table class="reportTable">
            ...
            <tr>
                <td colspan="2" style="text-align: left; padding-left: 5px"><b>STYLE VALUE </b></td>
                <td>{{ $reportData->order_value }} USD</td>
            </tr>
            <tr>
                <td colspan="2" style="text-align: left; padding-left: 5px"><b>BUDGET VALUE</b></td>
                <td>
            ...
            <tr>
                <td colspan="2" style="text-align: left; padding-left: 5px"><b>TRIMS COST</b></td>
                <td>
                    {{ $reportData->trims_cost_Value }} USD
                </td>
            </tr>
            <tr>
                <td colspan="2" style="text-align: left; padding-left: 5px"><b>OTHER COST</b></td>
                <td>
            ...
            <tr>
                <td colspan="2" style="text-align: left; padding-left: 5px"><b>KNITTING VALUE</b></td>
            ...
            <tr>
                <td colspan="2" style="text-align: left; padding-left: 5px"><b>FINISH FAB BALANCE VALUE</b></td>
                <td>
            ...
            <tr>
                <td colspan="2" style="text-align: left; padding-left: 5px"><b>CUTTING VALUE</b></td>
                <td>{{ $reportData->cutting_qty }} USD</td>
            </tr>
            <tr>
                <td colspan="2" style="text-align: left; padding-left: 5px"><b>PRINT SENT VALUE</b></td>
                <td>{{ $reportData->print_sent_value }} USD</td>
            </tr>
            <tr>
                <td colspan="2" style="text-align: left; padding-left: 5px"><b>PRINT RECEIVE VALUE</b></td>
                <td>{{ $reportData->print_receive_value }} USD</td>
            </tr>
            <tr>
                <td colspan="2" style="text-align: left; padding-left: 5px"><b>EMBR SENT VALUE</b></td>
                <td>{{ $reportData->embr_sent_value }} USD</td>
            </tr>
            <tr>
                <td colspan="2" style="text-align: left; padding-left: 5px"><b>EMBR RECEIVE VALUE</b></td>
                <td>{{ $reportData->embr_receive_value }} USD</td>
            </tr>
            <tr>
                <td colspan="2" style="text-align: left; padding-left: 5px"><b>INPUT VALUE</b></td>
                <td>{{ $reportData->input_value }} USD</td>
            </tr>

            <tr>
                <td colspan="2" style="text-align: left; padding-left: 5px"><b>SEWING VALUE</b></td>
                <td>{{ $reportData->sewing_value }} USD</td>
            </tr>
            <tr>
                <td colspan="2" style="text-align: left; padding-left: 5px"><b>PACKING VALUE</b></td>
                <td>{{ $reportData->packing_value }} USD</td>
            </tr>
            <tr>
                <td colspan="2" style="text-align: left; padding-left: 5px"><b>SHIPMENT VALUE</b></td>
