    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(document).on('submit', '#reportForm', function (e) {
                ...
                reportTable.empty();
                $.ajax({
                    url: "/order-status-report/get-report/2",
                    type: "get",
                    dataType: "html",
                    data: formData,
                    beforeSend() {
            ...
            $(document).on('click', '#report_pdf', function () {
                ...
                window.location.replace(`/order-status-report/get-report-pdf/2?${queryString}`);
            });
            ...
            $(document).on('click', '#report_excel', function () {
                ...
                window.location.replace(`/order-status-report/get-report-excel/2?${queryString}`);
            });
        });
