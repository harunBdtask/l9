    ...
    <div class="body-section" style="margin-top: 0px;">
        ...
        <table class="borderless">
            ...
            <tr>
                ...
                <th class="text-left"><b>Booking Value:</b></th>
            ...
            <div style="margin-top: 15px;">
                <table style="border: 1px solid black;">
                    ...
                    <tr>
                        ...
                        <th style="background-color: blanchedalmond;"><b>Amount</b></th>
                                ...
                                @foreach(collect($itemColorWise)->groupBy('uom') as $uom => $uomWise)
                                    @if(isset($uomWise) && count($uomWise) > 0 )
                                        <tr>
                                            ...
                                            <td class="text-right">{{ round(collect($uomWise)->sum('amount'))  }}</td>
                                            <td>{{ $uom }}</td>
                                            <td></td>
                                        </tr>
                                    @endif
                                ...
                                @foreach(collect($itemColorWise)->groupBy('uom') as $uom => $uomWise)
                                    @if(isset($uomWise) && count($uomWise) > 0 )
                                        <tr>
                                            ...
                                            <td>{{ round(collect($uomWise)->sum('amount'))  }}</td>
                                            <td>{{ $uom }}</td>
                                            <td></td>
                                        </tr>
                                    @endif
            ...
            <div style="margin-top: 15px;">
                <table style="border: 1px solid black;">
                    ...
                    <tr>
                        ...
                        <th style="background-color: blanchedalmond">Amount</th>
            ...
            <div style="margin-top: 15px;">
                <table style="border: 1px solid black;">
                    ...
                    <tr>
                        <th style="background-color: blanchedalmond;"><b>Item</b></th>
                        <th style="background-color: blanchedalmond;"><b>Item Description</b></th>
                        <th style="background-color: blanchedalmond;"><b>Item Sizes</b></th>
                        <th style="background-color: blanchedalmond;"><b>Gmts Sizes</b></th>
                        <th style="background-color: blanchedalmond;"><b>Ac. Qty</b></th>
                        <th style="background-color: blanchedalmond;"><b>T. Qty</b></th>
                        <th style="background-color: blanchedalmond;"><b>Amount</b></th>
                        <th style="background-color: blanchedalmond;"><b>UoM</b></th>
            ...
            <div style="margin-top: 15px;">
                <table style="border: 1px solid black;">
                    ...
                    <tr>
                        <th style="background-color: blanchedalmond;"><b>Item</b></th>
                        <th style="background-color: blanchedalmond;"><b>Item Description</b></th>
                        <th style="background-color: blanchedalmond;"><b>Gmts. Color</b></th>
                        <th style="background-color: blanchedalmond;"><b>Item Color</b></th>
                        <th style="background-color: blanchedalmond;"><b>Item Sizes</b></th>
                        <th style="background-color: blanchedalmond;"><b>Gmts Sizes</b></th>
                        <th style="background-color: blanchedalmond;"><b>Ac. Qty</b></th>
