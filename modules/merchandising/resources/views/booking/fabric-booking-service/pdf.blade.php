        ...
        <div class="page">
                        ...
                        <table class="borderless">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-left: 30px;" class="text-left">{{ isset($bookings) ? optional($bookings->buyer)->name : ''}} </td>
                                </tr>
            ...
            <div style="margin-top: 16mm">
                <table class="borderless">
                    <tbody>
                        <tr>
                            <td class="text-left" style="width: 170px"><b>Total Booking Amount :</b></td>
                ...
                <table class="borderless">
                    <tbody>
                        <tr>
                            ...
                            @endphp
                            <td class="text-left" style="width: 240px"><b>Total Booking Amount (In Words):</b></td>
