    ...
    <div class="body-section" style="margin-top: 0px;">
        <table class="borderless">
            ...
            <tr>
                ...
                <td class="text-right" style="text-align: right;">
                    ...
                    Booking Date:
                    <b> {{ $workOrder->booking_date ? date('j-M-Y', strtotime($workOrder->booking_date)) : '' }}</b><br>
                </td>
            </tr>
            </thead>
        </table>
        ...
        @if(isset($workOrder) && count($workOrder->gmtsColorWiseWorkOrder) >0)
            <div style="margin-top: 15px;">
                <table>
                    <tr>
                        <td colspan="8" class="text-center"><b>Work Order Details(As Per Gmts Color)</b></td>
                    </tr>
                    <tr>
                        <th>SL</th>
                        <th>Gmts Item</th>
        ...
        @if(isset($workOrder) && count($workOrder->colorSizeSensitivity) >0)
            <div style="margin-top: 15px;">
                <table>
                    <tr>
                        <td colspan="9" class="text-center"><b>Color Size Sensitivity</b></td>
                    </tr>
                    <tr>
                        <th>SL</th>
                        <th>Gmts. Item</th>
        ...
        @if(isset($workOrder) && count($workOrder->contrastColorWiseWorkOrder) >0)
            <div style="margin-top: 15px;">
                <table>
                    <tr>
                        <td colspan="9" class="text-center"><b>Contrast Color Sensitivity</b></td>
                    </tr>
                    <tr>
                        <th>SL</th>
                        <th>Gmts. Item</th>
        ...
        @if(isset($workOrder) && count($workOrder->sizeSensitivity) >0)
            <div style="margin-top: 15px;">
                <table>
                    <tr>
                        <td colspan="9" class="text-center"><b>Size Sensitivity</b></td>
                    </tr>
                    <tr>
                        <th>SL</th>
                        <th>Gmts. Item</th>
        ...
        @if(isset($workOrder) && count($workOrder->noSensitivity) >0)
            <div style="margin-top: 15px;">
                <table>
                    <tr>
                        <td colspan="9" class="text-center"><b>No Sensitivity</b></td>
                    </tr>
                    <tr>
                        <th>SL</th>
                        <th>Gmts. Item</th>
