                            ...
                            <table style="border: 1px solid black;width: 20%;">
                                ...
                                <tr>
                                    <td class="text-center">
                                        <span style="font-size: 12pt; font-weight: bold;">Order Recap Report</span>
                                        <br>
                                    </td>
                                </tr>
                                </thead>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.print').click(function (e) {
                ...
                let link = `{{ url('/orders-recap/print') }}?factory_id=${factory_id}&buyer_id=${buyer_id}&season_id=${season_id}&from_date=${from_date}&to_date=${to_date}&style_name=${style_name}`;
            ...
            $(document).on('change', '#buyer_id', function () {
                ...
                $.ajax({
                    method: 'GET',
                    url: `/orders/seasons?factoryId=${factoryId}&buyerId=${buyerId}`,
                    success: function (result) {
                        $.each(result, function (key, value) {
        ...
        $(document).on('click', '#order_pdf', function () {
            ...
            let link = `{{ url('/orders-recap/pdf') }}?factory_id=${factory_id}&buyer_id=${buyer_id}&season_id=${season_id}&from_date=${from_date}&to_date=${to_date}&style_name=${style_name}`;
