...
<div class="body-section" style="margin-top: 0px;">
    @php
        $fabricDetailsSum=0;
        $total_amount_sum = 0;
        $withoutPrice = request()->get('without-price');
    @endphp
    <table class="border">
        <thead>
        <tr>
            <td class="text-center">
                ...
                @else
                    <span style="font-size: 12pt; font-weight: bold;">     Fabric Booking summary </span>
                @endif
                    ...
                    @foreach($fabricDetailsUomWise as $index => $details)
                        ...
                        @foreach($details as $key => $item)
                            <tr>
                                ...
                                <td class="text-right">{{ $item['fabric_consumption'] ?? '' }}</td>
                                <td>{{ $item['uom']  ?? ''}}</td>
                        ...
                        <tr>
                            ...
                            <td class="text-right"><b>{{ number_format($total_actual_value,4) }}</b></td>
                            <td colspan="3"></td>
    ...
    @if(count($yarnDetails)>0 && request()->get('with-yarn-cost') == 'yes')
        <div style="margin-top: 15px">
            <table>
                <tr>
                    <th colspan="{{$withoutPrice ? 7 : 9}}" class="text-center"><b>Yarn Cost Details</b></th>
                </tr>
                <tr>
                    <th>Unique Id</th>
                    <th>Style</th>
