<div>
            ...
            <div style="margin-top: 15px;">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <th>Fin Type</th>
                        <th>Part Qty</th>
                        <th>Act. Cons (Finish)</th>
                        <th>Total. Cons (Grey)</th>
                        <th>Unit</th>
                        <th>Act.Fab.Qty</th>
                        <th>Loss</th>
                        <th>Total Fab. Qty</th>
            ...
            <table>
                ...
                @foreach($collarDetails as $key => $details)
                    <tr>
                        ...
                        <td class="text-right">{{ round($details['required_qty']) }}</td>
    ...
    <div style="margin-top: 10px;">
        <span><b>Attachment Note</b></span> <br>
        <span>{{ $fabricBookings->attachment_note }}</span> <br>
        <span><b>Attachment</b></span> <br>
        @if(($fabricBookings->attachment) && file_exists(storage_path('app/public/' . $fabricBookings->attachment)))
            <img style="height: 150px; width: 150px" alt=""
                 src="{{ asset("storage/$fabricBookings->attachment")  }}"
                 class="img-fluid">
        @else
        ...
        <br>
        <span><b>Control</b></span> <br>
        <span>{{ $fabricBookings->control }}</span> <br>
        <span><b>Attachment Note</b></span> <br>
        <span>{{ $fabricBookings->remarks }}</span> <br>

        <table style="width: 400px">
            <tr style="width: 400px">
                <th>Silicon & Engyme Wash</th>
                <th style="width: 50px"> {!!   $fabricBookings->silicon_engyme_wash == 1 ?  '&#10004;': null !!} Yes</th>
                <th style="width: 50px">{!! $fabricBookings->silicon_engyme_wash == 2 ? '&#10004;' : null !!}No</th>
