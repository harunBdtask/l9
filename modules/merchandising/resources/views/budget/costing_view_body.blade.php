        ...
        <div style="margin-top:10px">
            <table>
                <tr>
                    ...
                    <th colspan="3">LC/SC NO: {{ $lc['lc_number'] }}</th>
                </tr>
                <tr>
                    <th>SL.</th>
                    <th>PO NUMBER</th>
                ...
                <td>${{ number_format($po['unit_price'], 2) }}</td>
                @php
                ...
                <tr>
                    ...
                    <td>{{ $totalOrder }} {{ $order['uom'] }}</td>
                    <td></td>
                    <td><b>${{ number_format($totalOrderAmount, 2) }}</b></td>
                    <td colspan="2"></td>
                </tr>
            </table>
        </div>
        ...
        <div style="margin-top:10px">
            <table>
                ...
                <tr>
                    ...
                    <td><b>${{ number_format($fabricDetails->sum('total_amount'), 2) }}</b></td>
                    <td></td>
                </tr>
            </table>
        </div>
        ...
        <div style="margin-top:10px">
            <table>
                <tr>
                    ...
                    <th>ORDER QTY</th>
                    <th>EX %</th>
                    <th colspan="2" class="text-center">T. REQ</th>
                    <th>UNIT PRICE($)</th>
                    <th>TOTAL($)</th>
                    <th>SUPPLIER</th>
                </tr>
                ...
                <tr>
                    ...
                    <td><b>${{ $trimsDetails->sum('total_amount') }}</b></td>
                    <td></td>
                </tr>
            </table>
        </div>
