...
<main>
    <div class="page">
        <div class="">
            ...
            <br>
            @include('merchandising::price_quotation.pdf-table')
            ...
            {{--                        <td>{{ $fabricCostDetails->where('fabric_nature_id', 1)->sum('fabric_consumption_details.calculation.amount_sum') }}</td>--}}
            {{--                        <th><b>Woven Fabric Cons</b></th>--}}
            {{--                        <td>{{ $fabricCostDetails->where('fabric_nature_id', 2)->sum('fabric_consumption_details.calculation.amount_sum') }}</td>--}}
            ...
            {{--                    <tr>--}}
            {{--                        <th><b>OP Date</b></th>--}}
            {{--                        <td>{{ formatDate($price_quotation->op_date) ?? '' }}</td>--}}
            {{--                        <th><b>Est.Ship Date</b></th>--}}
            {{--                        <td>{{ formatDate($price_quotation->est_shipment_date) ?? '' }}</td>--}}
            {{--                        <th><b>Lead Time</b></th>--}}
            ...
            {{--                                <img style="height: 370px;margin-left: 5%" class="img-fluid"--}}
