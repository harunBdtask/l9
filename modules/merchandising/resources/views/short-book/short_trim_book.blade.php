        ...
        @if(Session::has('permission_of_recap_report_view') || Session::get('user_role') == 'super-admin' || Session::get('user_role') == 'super-admin')
            <div class="box knit-card">
                <div class="row in-print">
                    ...
                    <h4 class="text-center" style="margin-bottom: -5px;font-size: 16px">Trims Short Booking Report</h4>
                    <br>
                </div>
                <div class="box-header print-delete">
                    <h2>Trims Short Booking Report</h2>
                    <div class="clearfix"></div>
                </div>
                <div class="box-body b-t print-delete" >
                    <div class="row print-delete">
                        <div class="col-md-8">
                            <form class="form-inline print-delete" method="GET" action="{{ url('short-trim-book-search') }}" role="search">
                        ...
                        <div class="col-md-4 print-delete" align="right">
                            <ul>
                                ...
                                <li style="list-style: none;display: inline-block"><a href="{{ url('short-trim-book-pdf-download?month='.request()->month.'&year='.request()->year)}}" class="hidden-print btn btn-xs" title="Download this pdf"><i class="fa fa-file-pdf-o"></i>&nbsp;PDF</a></li>
                            </ul>
                        </div>
                    </div>
