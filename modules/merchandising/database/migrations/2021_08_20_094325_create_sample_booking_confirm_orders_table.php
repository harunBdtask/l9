...
class CreateSampleBookingConfirmOrdersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sample_booking_confirm_orders', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('sample_booking_confirm_orders');
    }
}
