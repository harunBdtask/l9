...
class CreateSampleBookingConfirmOrderDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sample_booking_confirm_order_details', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('sample_booking_confirm_order_details');
    }
}
