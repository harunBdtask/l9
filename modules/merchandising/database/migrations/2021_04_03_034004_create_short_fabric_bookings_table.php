...
class CreateShortFabricBookingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('short_fabric_bookings', function (Blueprint $table) {
            $table->id();
            $table->string('unique_id');
            $table->string('budget_unique_id')->nullable();
            ...
            $table->tinyInteger('responsible_department')->nullable();
            $table->string('file_no')->nullable();
            $table->string('fabric_composition')->nullable();
            $table->string('remarks')->nullable();
            $table->json('terms_condition')->nullable();
            $table->json('process_loss')->nullable();
            $table->json('collar_cuff_info')->nullable();
    ...
    {
        Schema::dropIfExists('short_fabric_bookings');
    }
}
