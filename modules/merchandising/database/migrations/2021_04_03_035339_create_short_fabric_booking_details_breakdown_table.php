...
class CreateShortFabricBookingDetailsBreakdownTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('short_fabric_booking_details_breakdown', function (Blueprint $table) {
            $table->id();
            $table->unsignedInteger('short_booking_id')->nullable();
    ...
    {
        Schema::dropIfExists('short_fabric_booking_details_breakdown');
    }
}
