...
class CreateTrimsBookingDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('trims_booking_details', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('trims_booking_details');
    }
}
