...
class TechPackApiController extends Controller
{
    /**
    ...
    public function __invoke(Request $request): JsonResponse
    {
        try {
            ...
            $response = collect($request->get('colors'))->map(function ($value) use ($colors) {
                ...
                return [
                    ...
                    'fabric_colors' => collect($fabric_colors)->take(1),
                ];
            });
