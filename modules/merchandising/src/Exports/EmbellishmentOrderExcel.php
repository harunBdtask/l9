...
class EmbellishmentOrderExcel implements WithTitle, FromView, WithEvents, ShouldAutoSize
{
    use Exportable;
    ...
    {
        $workOrders = $this->orders;
        return view('merchandising::work-orders.order-list-excel', compact('workOrders'));
    }
