...
class OrderRecapSummaryReport implements WithTitle, ShouldAutoSize, FromView, ShouldQueue, withEvents
{
    use Exportable;
    public $resultData;
    ...
    public function view(): View
    {
        ...
        return view('merchandising::recap.order_recap_summary_report_excel', $data);
    }
    ...
    public function registerEvents(): array
    {
        return [AfterSheet::class => function (AfterSheet $event) {
            ...
            $event->sheet->getDelegate()->getStyle('F5:F'.$highestRowNumber)->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER);
            $event->sheet->getDelegate()->getStyle('G5:G'.$highestRowNumber)->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER);
            $event->sheet->getDelegate()->getStyle('H5:I'.$highestRowNumber)->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER);
        }];
    }
    ...
    {
        return 'Order Recap Summary Report';
    }
}
