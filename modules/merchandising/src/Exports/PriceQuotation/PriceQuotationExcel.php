...
namespace SkylarkSoft\GoRMG\Merchandising\Exports\PriceQuotation;
...
class PriceQuotationExcel implements WithTitle, FromView, WithEvents, ShouldAutoSize
{
    use Exportable;
    ...
    {
        return 'Quotation List View';
    }

    public function view(): View
    {
        $price_quotations = $this->orders;
        return view('merchandising::price_quotation.quotation-list', compact('price_quotations'));
    }
