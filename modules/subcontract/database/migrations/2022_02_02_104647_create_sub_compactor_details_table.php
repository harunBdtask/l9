...
class CreateSubCompactorDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sub_compactor_details', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('sub_compactor_id');
    ...
    {
        Schema::dropIfExists('sub_compactor_details');
    }
}
