...
class CreateSubCompactorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sub_compactors', function (Blueprint $table) {
            $table->id();
            $table->string('sub_compactor_uid')->nullable();
            ...
            $table->string('compaction')->nullable();
    ...
    {
        Schema::dropIfExists('sub_compactors');
    }
}
