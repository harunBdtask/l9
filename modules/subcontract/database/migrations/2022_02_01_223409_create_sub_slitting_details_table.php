...
class CreateSubSlittingDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sub_slitting_details', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('sub_slitting_id');
    ...
    {
        Schema::dropIfExists('sub_slitting_details');
    }
}
