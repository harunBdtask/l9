...
class CreateSubDyeingSqueezerDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sub_dyeing_squeezer_details', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('sub_dyeing_squeezer_id');
    ...
    {
        Schema::dropIfExists('sub_dyeing_squeezer_details');
    }
}
