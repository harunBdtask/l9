...
class CreateSubDyeingStenteringDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sub_dyeing_stentering_details', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('sub_stentering_id');
    ...
    {
        Schema::dropIfExists('sub_dyeing_stentering_details');
    }
}
