...
class CreateSubDyeingRecipeDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sub_dyeing_recipe_details', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('sub_dyeing_recipe_id');
    ...
    {
        Schema::dropIfExists('sub_dyeing_recipe_details');
    }
}
