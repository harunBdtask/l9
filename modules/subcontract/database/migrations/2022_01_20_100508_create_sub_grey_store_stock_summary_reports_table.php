...
class CreateSubGreyStoreStockSummaryReportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sub_grey_store_stock_summary_reports', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('sub_grey_store_stock_summary_reports');
    }
}
