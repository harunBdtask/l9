...
class CreateSubDryerDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sub_dryer_details', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('sub_dryer_id');
    ...
    {
        Schema::dropIfExists('sub_dryer_details');
    }
}
