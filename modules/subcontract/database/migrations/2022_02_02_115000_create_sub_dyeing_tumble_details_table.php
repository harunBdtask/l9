...
class CreateSubDyeingTumbleDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sub_dyeing_tumble_details', function (Blueprint $table) {
            $table->id();
            $table->unsignedInteger('sub_dyeing_tumble_id');
    ...
    {
        Schema::dropIfExists('sub_dyeing_tumble_details');
    }
}
