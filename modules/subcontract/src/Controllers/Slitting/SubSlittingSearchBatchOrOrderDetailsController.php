...
use SkylarkSoft\GoRMG\Subcontract\Requests\DyeingProcessRequests\SubSlittingSearchRequest;
use SkylarkSoft\GoRMG\Subcontract\Services\SubTextileServices\States\DetailsStates\DetailsState;
use Symfony\Component\HttpFoundation\Response;

class SubSlittingSearchBatchOrOrderDetailsController extends Controller
{
    /**
     * @param SubSlittingSearchRequest $request
     * @return JsonResponse
     */
    public function __invoke(SubSlittingSearchRequest $request): JsonResponse
    {
        try {
