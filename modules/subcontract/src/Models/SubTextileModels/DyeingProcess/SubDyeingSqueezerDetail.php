...
class SubDyeingSqueezerDetail extends Model
{
    use SoftDeletes;
    use CommonModelTrait;
    use BelongsToFactory;

    protected $table = "sub_dyeing_squeezer_details";
    protected $primaryKey = "id";
    protected $fillable = [
        "sub_dyeing_squeezer_id",
        "order_id",
        "order_no",
        "batch_id",
        "batch_no",
    ...
    public function subDyeingSqueezer(): BelongsTo
    {
        return $this->belongsTo(SubDyeingSqueezer::class, 'sub_dyeing_squeezer_id')->withDefault();
    }
