...
class SubDyeingTubeCompactingDetail extends Model
{
    use SoftDeletes;
    use CommonModelTrait;
    use BelongsToFactory;

    protected $table = "sub_dyeing_tube_compacting_details";
    protected $primaryKey = 'id';
    protected $fillable = [
        'sub_dyeing_tube_compacting_id',
        'order_id',
        'order_no',
        'batch_id',
        'batch_no',
    ...
    public function subDyeingTubeCompacting(): BelongsTo
    {
        return $this->belongsTo(SubDyeingTubeCompacting::class, 'sub_dyeing_tube_compacting_id')->withDefault();
    }
