...
class SubCompactorDetail extends Model
{
    use SoftDeletes;
    use CommonModelTrait;
    use BelongsToFactory;

    protected $table = 'sub_compactor_details';
    ...
    public function subCompactor(): BelongsTo
    {
        return $this->belongsTo(SubCompactor::class, 'sub_compactor_id')->withDefault();
    }
