...
class SubDyeingTumbleDetail extends Model
{
    use SoftDeletes;
    use CommonModelTrait;

    protected $table = 'sub_dyeing_tumble_details';
    protected $primaryKey = 'id';
    protected $fillable = [
        'sub_dyeing_tumble_id',
        'sub_dyeing_batch_id',
        'sub_dyeing_batch_no',
    ...
    public function tumble(): BelongsTo
    {
        return $this->belongsTo(
            SubDyeingTumble::class,
            'sub_dyeing_tumble_id',
            'id'
        )->withDefault();
    }
