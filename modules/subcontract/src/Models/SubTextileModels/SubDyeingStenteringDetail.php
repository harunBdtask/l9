...
class SubDyeingStenteringDetail extends Model
{
    use SoftDeletes;
    use CommonModelTrait;
    use BelongsToFactory;

    protected $table = 'sub_dyeing_stentering_details';
    ...
    public function subDyeingStentering(): BelongsTo
    {
        return $this->belongsTo(SubDyeingStentering::class, 'sub_stentering_id')->withDefault();
    }
