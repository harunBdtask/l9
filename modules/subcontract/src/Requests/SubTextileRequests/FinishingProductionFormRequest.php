...
class FinishingProductionFormRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'machine_id' => 'required',
            'shift_id' => 'required',
            'finishing_production_details.*.no_of_roll' => 'required',
            'finishing_production_details.*.finish_qty' => 'required',
            'finishing_production_details.*.unit_cost' => 'required',
        ];
    }
