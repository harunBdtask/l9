...
class IssueBasis implements BatchDetailsContract
{
    public function format(Request $request)
    {
        return SubGreyStoreIssueDetail::query()
            ->with([
                'subDyeingOrder',
                'color',
                'subGreyStoreOrderDetail.subGreyStoreReceiveDetail',
            ])
            ...
            ->map(function ($collection) {
                ...
                return [
                    ...
                    'batch_weight' => $collection->issue_qty,
                    'total_receive_qty' => $totalReceiveQty,
                    'balance' => $totalReceiveQty - $collection->issue_qty,
                    'remarks' => null,
                ];
