...
@section('title','Order Wise Stock Report')
@section('content')
    <style type="text/css">
        #pdfGenerateInfo {
            display: none;
                                ...
                                <div class="col-md-12">
                                    <div class="col-sm-2" style="width: 20%;">
                                        <div class="form-group">
                                            <label style="margin-bottom: -2.5rem;">Operations</label>
                                            <select name="" id="operation_id"
                ...
                <div class="">
                    <div class="header-section" style="padding-bottom: 0px;">
                        <div class="pull-right" style="margin-bottom: -5%;">
                            ...
                            <a id="order_wise_stock_report_pdf" data-value="" class="btn"
                               href="">
                                <em class="fa fa-file-pdf-o"></em></a>

                            <a id="order_wise_stock_report_excel" data-value="" class="btn"
                               href="">
                        ...
                        <table style="border: 1px solid black;width: 20%;">
                            ...
                            <tr>
                                <td class="text-center">
                                    <span
                                        style="font-size: 10pt; font-weight: bold;">Order Wise Stock Report</span>
                                    <br>
                                </td>
                            </tr>
                            </thead>
        ...
        @push("script-head")
            <script>
                $(document).on('click', '#dyeingLedgerReport', function (event) {
                    ...
                    $.ajax({
                        method: 'GET',
                        url: `/subcontract/report/order-wise-stock-report/get-report`,
                        data: {
                            form_date,
                            to_date,
                            order_id,
                        ...
                        success: function (result) {
                            let pdfQueryString = `/subcontract/report/order-wise-stock-report/pdf?form_date=${form_date}
                                              &to_date=${to_date}&order_id=${order_id}&supplier_id=${supplier_id}
                                              &color_id=${color_id}&operation_id=${operation_id}`;
                            let excelQueryString = `/subcontract/report/order-wise-stock-report/excel?form_date=${form_date}
                                              &to_date=${to_date}&order_id=${order_id}&supplier_id=${supplier_id}
                                              &color_id=${color_id}&operation_id=${operation_id}`;
                            $('#Table').html(result);
                            $("#order_wise_stock_report_pdf").attr('href', pdfQueryString);
                            $("#order_wise_stock_report_excel").attr('href', excelQueryString);
                        },
