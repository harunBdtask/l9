...
@section('title','Challan Wise Receive Report')
@section('content')
    <style type="text/css">
        #pdfGenerateInfo {
            display: none;
    ...
    <div class="padding">
        <div class="box">
            <div class="box-header">
                <h2>Challan Wise Receive Report</h2>
                ...
                <div class="">
                    <div class="header-section" style="padding-bottom: 0px;">
                        <div class="pull-right" style="margin-bottom: -5%;">
                            ...
                            <a id="dyeing_ledger_report_pdf" data-value="" class="btn"
                               href="">
                                <em class="fa fa-file-pdf-o"></em></a>

                            <a id="dyeing_ledger_report_excel" data-value="" class="btn"
                               href="">
                        ...
                        <table style="border: 1px solid black;width: 20%;">
                            ...
                            <tr>
                                <td class="text-center">
                                    <span
                                        style="font-size: 10pt; font-weight: bold;">Challan Wise Receive Report</span>
                                    <br>
                                </td>
                            </tr>
                            </thead>
        ...
        @push("script-head")
            <script>
                $(document).on('click', '#dyeingLedgerReport', function (event) {
                    ...
                    $.ajax({
                        method: 'GET',
                        url: `/subcontract/report/dyeing-ledger-report/get-report`,
                        data: {
                            form_date,
                            to_date,
                            order_id,
                        ...
                        success: function (result) {
                            let pdfQueryString = `/subcontract/report/dyeing-ledger-report/pdf?form_date=${form_date}
                                              &to_date=${to_date}&order_id=${order_id}&supplier_id=${supplier_id}
                                              &color_id=${color_id}&operation_id=${operation_id}`;
                            let excelQueryString = `/subcontract/report/dyeing-ledger-report/excel?form_date=${form_date}
                                              &to_date=${to_date}&order_id=${order_id}&supplier_id=${supplier_id}
                                              &color_id=${color_id}&operation_id=${operation_id}`;
                            $('#Table').html(result);
                            $("#dyeing_ledger_report_pdf").attr('href', pdfQueryString);
                            $("#dyeing_ledger_report_excel").attr('href', excelQueryString);
                        },
