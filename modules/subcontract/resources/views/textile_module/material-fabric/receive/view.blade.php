    ...
    <div class="padding">
        <div class="box">
            <div class="box-header">
                <h2>Material Fabric Receive Details</h2>
            </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="header-section" style="padding-bottom: 0px;">
                            <div class="pull-right" style="margin-bottom: -5%;">
                                <a id="order_pdf" data-value="po_details" class="btn" href="{{ url('subcontract/material-fabric-receive/pdf/'.$fabricReceive->id) }}"><i class="fa fa-file-pdf-o"></i></a>
                            </div>
                        </div>
                                ...
                                <table class="reportTable" style="width: 100%;margin-top: 30px;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $receive->receive_return_qty }}</td>
