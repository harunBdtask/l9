...
namespace SkylarkSoft\GoRMG\Finishingdroplets;

use Illuminate\Support\ServiceProvider as LaravelProvider;
use Illuminate\Support\Facades\View;
use SkylarkSoft\GoRMG\Finishingdroplets\Models\HourWiseFinishingProduction;
use SkylarkSoft\GoRMG\Finishingdroplets\Observers\HourWiseFinishingProductionObserver;
use SkylarkSoft\GoRMG\Finishingdroplets\Models\Poly;
use SkylarkSoft\GoRMG\Finishingdroplets\Observers\PolyObserver;
...
class ServiceProvider extends LaravelProvider
{
    ...
    public function boot()
    {
        ...
        $this->publishAssets();
        Poly::observe(PolyObserver::class);
        HourWiseFinishingProduction::observe(HourWiseFinishingProductionObserver::class);
    }
