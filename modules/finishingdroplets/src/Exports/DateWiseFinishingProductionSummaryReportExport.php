...
class DateWiseFinishingProductionSummaryReportExport implements WithTitle, ShouldAutoSize, FromView, ShouldQueue, WithEvents
{
    ...
    public function view(): View
    {
        ...
        return view('finishingdroplets::reports.downloads.excels.date_wise_finishing_summary_report_download', $data);
    }
