...
class CreateSampleOrderRequisitionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sample_order_requisitions', function (Blueprint $table) {
            $table->id();
            $table->string('requisition_id', 50)->nullable();
            $table->string('sample_stage', 50);
            $table->date('req_date');
    ...
    {
        Schema::dropIfExists('sample_order_requisitions');
    }
}
