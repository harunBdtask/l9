...
class CreateV3TrimsStoreDailyStockSummariesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('v3_trims_store_daily_stock_summaries', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('v3_trims_store_daily_stock_summaries');
    }
}
