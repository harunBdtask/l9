...
class CreateV3TrimsStoreIssueReturnDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('v3_trims_store_issue_return_details', function (Blueprint $table) {
            $table->id();
            $table->string('unique_id')->nullable();
            $table->unsignedBigInteger('trims_store_issue_return_id');
    ...
    {
        Schema::dropIfExists('v3_trims_store_issue_return_details');
    }
}
