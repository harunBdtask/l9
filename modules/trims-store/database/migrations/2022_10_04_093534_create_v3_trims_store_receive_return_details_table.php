...
class CreateV3TrimsStoreReceiveReturnDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('v3_trims_store_receive_return_details', function (Blueprint $table) {
            $table->id();
            $table->string('unique_id')->nullable();
            $table->unsignedBigInteger('trims_store_receive_return_id');
            $table->unsignedBigInteger('return_to');
    ...
    {
        Schema::dropIfExists('v3_trims_store_receive_return_details');
    }
}
