                    ...
                    <div class="col-md-12">
                        <div class="header-section" style="padding-bottom: 0;">
                            <div class="pull-right" style="margin-bottom: -5%;">
                                <a class="btn" href="{{ url("trims-store/receive-return/$receiveReturn->id/pdf") }}">
                            ...
                            <table style="border: 1px solid black; width: 20%; margin-bottom: 40px;">
                                ...
                                <tr>
                                    <td class="text-center">
                                        <span style="font-size: 12pt; font-weight: bold;">Trims Store Receive Return</span>
                                        <br>
                                    </td>
                                </tr>
                                </thead>
                        ...
                        @include('trims-store::v3.receive-return.view-body')
