    ...
    <div class="padding">
        <div class="box">
            ...
            <div class="box-body table-responsive b-t">
                <div class="row">
                    <div class="col-sm-9">
                        <a class="btn btn-sm btn-info" href="{{ url('/dyes-store/brands/create') }}">
                            <i class="glyphicon glyphicon-plus"></i> New Brand
                        </a>
                    </div>
                    <div class="col-sm-3">
                        <form action="{{ url('/dyes-store/brands') }}" method="GET">
                        ...
                        <table class="reportTable">
                            ...
                            @forelse($brands as $brand)
                                <tr>
                                    ...
                                    <td>{{ $brand->name }}</td>
                                    <td>
                                        <a href="{{url('/dyes-store/brands/'.$brand->id.'/edit')}}"
                                        ...
                                        <button type="button" class="btn btn-xs btn-danger show-modal"
                                                ...
                                                ui-target="#animate"
                                                data-url="{{ url('/dyes-store/brands/'.$brand->id) }}">
