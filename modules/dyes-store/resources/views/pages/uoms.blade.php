    ...
    <div class="padding">
        <div class="box">
            ...
            <div class="box-body table-responsive b-t">
                <div class="row">
                    <div class="col-sm-9">
                        <a class="btn btn-sm btn-info" href="{{ url('/dyes-store/uom/create') }}">
                            <i class="glyphicon glyphicon-plus"></i> New UOM
                        </a>
                    </div>
                    <div class="col-sm-3">
                        <form action="{{ url('/dyes-store/uom') }}" method="GET">
                        ...
                        <table class="reportTable">
                            ...
                            @forelse($uoms as $uom)
                                <tr>
                                    ...
                                    <td>{{ $uom->name }}</td>
                                    <td>
                                        <a href="{{url('/dyes-store/uom/'.$uom->id.'/edit')}}" class="btn btn-xs btn-success"
                                           data-toggle="tooltip" data-placement="top" title="Edit"><i
                                                class="fa fa-edit"></i></a>
                                        <button type="button" class="btn btn-xs btn-danger show-modal" data-toggle="modal"
                                                data-target="#confirmationModal" ui-toggle-class="flip-x"
                                                ui-target="#animate"
                                                data-url="{{ url('/dyes-store/uom/'.$uom->id) }}">
