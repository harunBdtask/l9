    ...
    <div class="padding">
        <div class="box">
            ...
            <div class="box-body table-responsive b-t">
                <div class="row">
                    <div class="col-sm-9">
                        <a class="btn btn-sm btn-info" href="{{ url('/dyes-store/customers/create') }}">
                            <i class="glyphicon glyphicon-plus"></i> New Customer
                        </a>
                    </div>
                    <div class="col-sm-3">
                        <form action="{{ url('dyes-store/customers') }}" method="GET">
                        ...
                        <table class="reportTable">
                            ...
                            @forelse($customers as $customer)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{url('/dyes-store/customers/'.$customer->id.'/edit')}}"
                                        ...
                                        <button type="button" class="btn btn-xs btn-danger show-modal" data-toggle="modal"
                                                ...
                                                ui-target="#animate"
                                                data-url="{{ url('/dyes-store/customers/'.$customer->id) }}">
