            ...
            <div class="col-md-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        {!! Form::open(['url' => "/dyes-store/items", 'method' => 'post', 'id' => 'form']) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                @endforeach
                                {{ Form::label('uom', 'UoM*') }}
                                {{ Form::select('uom', $uoms_data, $defaultUom ?? null, ['class' => 'form-control select-option',  'required', "data-parsley-required-message" => "UoM is required", 'id' => 'uom_select', 'placeholder' => 'Unit Of Measurement','style'=>'height:38px']) }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                {{ Form::select('category_id', $items_category, $itemCategory ?? null, ['class' => 'form-control',"required", "data-parsley-required-message" => "Category is required", 'id' => 'category_id', 'placeholder' => 'Select Category','style'=>'height:38px']) }}
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                {{ Form::select('brand_id', $brands_data, $defaultBrand ?? null, ['class' => 'form-control', 'id' => 'brand_id', 'placeholder' => 'Select Brand','style'=>'height:38px']) }}
                                @component('dyes-store::alert', ['name' => 'brand_id']) @endcomponent
                            </div>
