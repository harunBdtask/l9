                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                {!! Form::model($brand, ['url' => $brand ? '/dyes-store/brands/'.$brand->id : '/dyes-store/brands/', 'method' => $brand ? 'PUT' : 'POST']) !!}
                                ...
                                <div class="form-group row m-t-md">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        ...
                                        <a class="btn btn-danger" href="{{ url('/dyes-store/brands') }}">Cancel</a>
                                    </div>
                                </div>
                                {!! Form::close() !!}
                            </div>
