    ...
    <div class="padding">
        <div class="box">
            <div class="box-header">
                <h2>Dyes & Chemicals Summary Report</h2>
            ...
            <div class="box-body table-responsive b-t">
                <div class="row m-b-2">
                    <form action={{ url("/dyes-store/dyes-stock-summary-report") }} method="GET" id="form">
                        ...
                        <table class="reportTable" id="header-fixed">
                            ...
                            @if(isset($items))
                                ...
                                @foreach($items as $key => $item)
                                    @php
                                        $stockDetails = $item->dyesStock($first_date,$last_date, $storeId);
                                    ...
                                    @endphp
                                    @include('dyes-store::report.dyes_chemicals.stock_summary_report_table_row',[
