  ...
  <div class="padding">
    <div class="box" >
      ...
      <div class="box-body b-t">
        @if(Session::has('permission_of_cutting_table_edit') || getRole() == 'super-admin' || getRole() == 'admin')
          ...
          @if(!$tables->getCollection()->isEmpty())
            @foreach($tables->getCollection() as $table)
              <tr>
                ...
                <td>{{ $table->cuttingFloor->floor_no ?? '' }}</td>
                ...
                <td>
                  ...
                  @endif
                  @if(Session::has('permission_of_cutting_table_delete') || getRole() == 'super-admin' || getRole() == 'admin')
