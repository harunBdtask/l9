...
class LineWiseSewingReportExport implements WithTitle, ShouldAutoSize, FromView, ShouldQueue, WithEvents
{
    ...
    public function view(): View
    {
        ...
        return view('sewingdroplets::reports.tables.floor_line_wise_sewing_report_table', $data);
    }
