...
class MonthlyLineWiseProductionSummaryReportExport implements WithTitle, ShouldAutoSize, FromView, ShouldQueue, WithEvents
{
    ...
    public function view(): View
    {
        ...
        return view('sewingdroplets::reports.downloads.excels.monthly_line_wise_production_summary_report_download', $data);
    }
