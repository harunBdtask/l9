...
class DailyInputOutputReportExport implements WithTitle, ShouldAutoSize, FromView, ShouldQueue, WithEvents
{
    ...
    public function view(): View
    {
        ...
        return view('sewingdroplets::reports.downloads.excels.daily_input_output_report_download', $data);
    }
