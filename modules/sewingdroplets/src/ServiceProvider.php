...
namespace SkylarkSoft\GoRMG\Sewingdroplets;

use SkylarkSoft\GoRMG\Sewingdroplets\Commands\UpdateDateWiseHourlySewingProductionSummaryCommand;
use Illuminate\Support\ServiceProvider as LaravelProvider;
use Illuminate\Support\Facades\View;
use SkylarkSoft\GoRMG\Sewingdroplets\Commands\UpdateGarmentsItemInHourlySewingProductionReportCommand;
use SkylarkSoft\GoRMG\Sewingdroplets\Models\Sewingoutput;
use SkylarkSoft\GoRMG\Sewingdroplets\Observers\SewingoutputObserver;
...
class ServiceProvider extends LaravelProvider
{
    ...
    public function boot()
    {
        ...
        $this->commands([
            UpdateGarmentsItemInHourlySewingProductionReportCommand::class,
            UpdateDateWiseHourlySewingProductionSummaryCommand::class,
        ]);

        Sewingoutput::observe(SewingoutputObserver::class);
    }
