    ...
    <div class="padding">
        <div class="box">
            ...
            <div class="box-body table-responsive b-t">
                <div class="row">
                    <div class="col-sm-9">
                        <a href="{{ url('/general-store/items-category/create') }}" class="btn btn-primary btn-sm">
                            <i class="fa fa-plus"></i> Create Items Category
                        </a>
                    </div>
                    <div class="col-sm-3">
                        <form action="{{ url('/general-store/items-category/') }}" method="GET">
                        ...
                        <table class="reportTable">
                            ...
                            @forelse($items_category as $key=>$category)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{url('/general-store/items-category/'.$category->id.'/edit')}}" class="btn btn-xs btn-success"
                                           data-toggle="tooltip" data-placement="top" title="Edit"><i
                                                class="fa fa-edit"></i></a>
                                        <button type="button" class="btn btn-xs btn-danger show-modal" data-toggle="modal"
                                                data-target="#confirmationModal" ui-toggle-class="flip-x"
                                                ui-target="#animate"
                                                data-url="{{ url('/general-store/items-category/'.$category->id) }}">
