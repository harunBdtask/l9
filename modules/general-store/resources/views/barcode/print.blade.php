...
<div class="box">
    <div class="box-header">
        ...
        <h4 class="text-center">{{ factoryAddress() ?? '' }}</h4>
        <h4 class="text-center">{{ 'Barcode For ( ' . get_store_name($voucher->store) . ' )' }}</h4>
    ...
    <hr> {{-- onclick="window.print()" --}}
    <div class="box-body" id="box-body">
        @if(isset($barcodes))
            @foreach($barcodes->chunk(4) as $chunk)
