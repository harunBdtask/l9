    ...
    <div class="padding">
        <div class="box">
            ...
            <div class="box-body table-responsive b-t">
                <div class="row m-b-2">
                    <form action={{ url("/general-store/stores/{$store}/item-wise-summery") }} method="GET" id="form">
                        <div class="col-md-3 form-group">
                            ...
                            @component('general-store::alert', ['name' => 'first_date']) @endcomponent
                        </div>
                        <div class="col-md-3 form-group width-custom">
                            ...
                            @component('general-store::alert', ['name' => 'last_date']) @endcomponent
                        </div>
                        ...
                        <table class="reportTable" id="header-fixed">
                            ...
                            @if(isset($item_transaction_date))
                                ...
                                @foreach($item_transaction_date as $key => $value)
                                    ...
                                    @endphp
                                    @include('general-store::report.item_wise_report_table_row', [
                                        "stockDetails"=> $stockDetails,
                                        "item" => $item
                                    ])
                                @endforeach
                                @include('general-store::report.item_wise_report_table_row_summery',[
