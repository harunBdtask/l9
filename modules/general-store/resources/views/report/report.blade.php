    ...
    <div class="padding">
        <div class="box">
            ...
            <div class="box-body table-responsive b-t">
                <div class="row m-b-2">
                    <form action={{ url("/general-store/stores/{$store}/report") }} method="GET" id="form">
                        {{--first date--}}
                        ...
                        <table class="reportTable" id="header-fixed">
                            ...
                            @if(isset($items))
                                ...
                                @foreach($items as $key => $item)
                                    ...
                                    @endphp
                                    @include('general-store::report.table_row',[
                                ...
                                @if ($items->currentPage() == $items->lastPage())
                                    @include('general-store::report.table_row_summery', [
