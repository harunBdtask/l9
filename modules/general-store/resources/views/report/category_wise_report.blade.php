    ...
    <div class="padding">
        <div class="box">
            ...
            <div class="box-body table-responsive b-t">
                <div class="row m-b-2">
                    <form action={{ url("/general-store/stores/{$store}/report2") }} method="GET" id="form">
                        {{--first date--}}
                            ...
                            @if(isset($categories))
                                <tbody>
                                    ...
                                    @foreach($categories as $key => $category)
                                        ...
                                        @foreach ($items as $item)
                                            @if ($item['category_id'] == $category->id)
                                                ...
                                                @endphp
                                                @include('general-store::report.category_wise_report_table_row', [
                                                    "type" => $type,
                                                    "items" => $items,
                                    ...
                                    @if ($categories->currentPage() == $categories->lastPage())
                                        @include('general-store::report.category_wise_report_summery', [
