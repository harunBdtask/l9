    ...
    <div class="padding">
        <div class="box">
            ...
            <div class="box-body table-responsive b-t">
                <div class="row m-b-2">
                    <form action={{ url("/general-store/stores/daily/{$store}/report") }} method="GET" id="form">
                        {{-- @csrf --}}
                        {{--first date--}}
                        ...
                        <table class="reportTable" id="header-fixed">
                            ...
                            @if(isset($items))
                                <tbody>
                                    ...
                                    @endphp
                                        @include('general-store::report.daily_report_table_row',[
                                            "stockDetails"=>$stockDetails
                                        ])
                                    @endforeach
                                    @include('general-store::report.daily_report_table_row_summery',[
