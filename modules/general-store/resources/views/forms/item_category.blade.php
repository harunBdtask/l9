            ...
            <div class="col-md-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        {!! Form::model($category, ['url' => $category ? '/general-store/items-category/'.$category->id : '/general-store/items-category', 'method' => $category ? 'PUT' : 'POST']) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                @component('general-store::alert', ['name' => 'code']) @endcomponent
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                @component('general-store::alert', ['name' => 'parent_id']) @endcomponent
                            </div>
                            <div class="col-md-4 form-group">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <a href="{{ route('items-category.index') }}" class="btn btn-danger btn-sm">Cancel</a>
                            </div>
                        </div>
                        {!! Form::close() !!}
