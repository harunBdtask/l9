...
class GsItem extends Model
{
    ...
    {
        return $this->hasMany(GsInvTransaction::class, "item_id", "id");
    }
    ...
    {
        return $this->transactions()->where("trn_type", "in");
    }
    ...
    {
        return $this->transactions()->where("trn_type", "out");
    }
    ...
    {
        return $this->belongsTo(GsUom::class, "uom")->withDefault();
    }
    ...
    {
        return $this->belongsTo(GsInvItemCategory::class, 'category_id')->withDefault();
    }
    ...
    {
        return $this->belongsTo(GsBrand::class, 'brand_id')->withDefault();
    }
    ...
    {
        return $this->belongsTo(Stores::class, 'store')->withDefault();
    }
    ...
    public function scopeWithAvlQty($query)
    {
        $query->addSubSelect('avl_qty', function ($query) {
            ...
            $query->select(DB::raw($aggregator))
                ->from('gs_inv_transactions')
                ->whereColumn('item_id', 'gs_inv_items.id');
        });
    }
