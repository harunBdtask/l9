...
<div class="main-section">
	<div class="bottom-section">
		<table class="reportTable">
			<thead>
			<tr>
				<th colspan="6">Date of: {{ isset($from_date) ? date('d-M-Y', strtotime($from_date)) : '' }}
					To {{ isset($to_date) ? date('d-M-Y', strtotime($to_date)) : '' }}</th>
			</tr>
			<tr>
				<th>SL. No.</th>
				<th>Unique ID</th>
			...
			@if($reports && $reports->count())
				<tr>
					<th colspan="6">Section : {{ $reports->first()->employeeOfficialInfo->sectionDetails->name }}</th>
				</tr>
